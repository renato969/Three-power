...
<meta name="apple-mobile-web-app-title" content="Tr\xEAs Poderes">
<title>Tr\xEAs Poderes</title>
<link rel="manifest" href="/manifest.json">
...
<body>
<div class="paywall-overlay" id="recuperarOverlay">
  <div class="paywall-card" style="text-align:center;">
    <button class="paywall-close" id="recuperarClose">\u2715</button>
    <div style="font-family:'Fraunces',serif; font-weight:600; font-size:19px; color:var(--parchment); margin-bottom:8px;">Recuperar acesso</div>
    <div style="font-size:12.5px; color:var(--dim); margin-bottom:16px; line-height:1.5;">Digite o email que voc\xEA usou pra assinar. Se tiver uma assinatura ativa, mandamos um link pra entrar neste aparelho.</div>
    <input type="email" id="recuperarEmail" placeholder="seu@email.com" style="width:100%; padding:11px; border-radius:7px; border:1px solid var(--rule); background:rgba(244,238,223,0.04); color:var(--parchment); font-size:13px; margin-bottom:12px; box-sizing:border-box;">
    <button id="recuperarEnviar" class="btn-gold" style="display:block; width:100%; padding:12px; border-radius:8px; border:none; font-family:'Inter',sans-serif; font-weight:600; font-size:13.5px;">Enviar link \u2192</button>
    <div id="recuperarMsg" style="font-size:11.5px; color:var(--dim); margin-top:12px; display:none; line-height:1.4;"></div>
  </div>
</div>
...
<div class="paywall-overlay" id="boasVindasOverlay">
  <div class="paywall-card" style="text-align:center;">
    ...
    <div style="font-family:'Fraunces',serif; font-weight:600; font-size:21px; color:var(--parchment); margin-bottom:8px;" id="boasVindasNome">Parab\xE9ns!</div>
    <div style="font-size:13.5px; color:var(--dim); margin-bottom:22px; line-height:1.5;">Agora voc\xEA pode treinar diariamente os seus poderes.</div>
    <button id="boasVindasFechar" class="btn-gold" style="display:block; width:100%; padding:13px; border-radius:8px; border:none; font-family:'Inter',sans-serif; font-weight:600; font-size:14px;">Come\xE7ar agora \u2192</button>
  </div>
</div>
...
<div class="paywall-overlay" id="paywallOverlay">
  <div class="paywall-card">
    ...
    <div style="font-family:'IBM Plex Mono',monospace; font-size:10.5px; letter-spacing:.08em; text-transform:uppercase;
      color:var(--ink); background:var(--brass); display:inline-block; padding:4px 10px; border-radius:20px; margin-bottom:14px;">2 meses de gra\xE7a no anual</div>
    ...
    <div style="font-size:13px; color:var(--dim); margin-bottom:18px;">Treine as leis universais todos os dias, com exerc\xEDcios di\xE1rios e as cinco leis do livro. O Eneagrama continua gr\xE1tis, sempre.</div>
    ...
    <div style="font-size:11px; color:var(--dim); margin:4px 0 16px;">menos de R$31/m\xEAs, cobrado uma vez s\xF3</div>
    ...
    <div style="font-size:11.5px; color:var(--dim);">Prefere m\xEAs a m\xEAs? <a href="https://pay.kiwify.com.br/cfcPgdx" target="_blank" style="color:var(--brass);">R$37,70/m\xEAs</a></div>
    <div style="border-top:1px solid var(--rule); margin-top:16px; padding-top:14px;">
      <div style="font-size:11px; color:var(--dim); margin-bottom:8px;">J\xE1 assinou? A confirma\xE7\xE3o \xE0s vezes demora alguns segundos.</div>
      <button id="jaAssineiBtn" style="width:100%; background:none; border:1px solid var(--brass-dim); color:var(--brass);
        font-family:'Inter',sans-serif; font-size:12.5px; font-weight:600; padding:10px; border-radius:7px;">J\xE1 assinei, verificar agora</button>
      <div id="jaAssineiMsg" style="font-size:11px; color:var(--dim); margin-top:8px; display:none;"></div>
      <div style="font-size:11px; color:var(--dim); margin-top:10px;">Assinou com outro email, ou trocou de aparelho? <a href="#" id="abrirRecuperarLink" style="color:var(--brass);">Recuperar acesso</a></div>
    </div>
  </div>
</div>
...
<div class="install-banner" id="installBanner">
  ...
  <div class="txt" id="installTxt"><b>Instale o app.</b> Fica na tela de in\xEDcio, abre sem navegador.</div>
...
<div class="app">
  ...
  <section class="view active" id="viewTreino">
    ...
    <div class="lock-teaser" id="treinoLockBanner">
      ...
      <div class="body">
        ...
        <p>Gera exerc\xEDcios todo dia mirando exatamente o seu ponto mais fraco entre racioc\xEDnio, discernimento e influ\xEAncia, a partir do seu pr\xF3prio diagn\xF3stico. N\xE3o \xE9 gen\xE9rico.</p>
        <div class="btn-row" style="margin-top:0;">
          ...
          <button class="abrirRecuperarLink2" style="background:none; border:1px solid var(--brass-dim); color:var(--brass);
            font-family:'Inter',sans-serif; font-size:13px; font-weight:600; padding:10px 16px; border-radius:8px;">J\xE1 sou assinante</button>
        </div>
      </div>
    </div>
    ...
    <div class="topbar">
      <div class="topbar-inner">
        ...
        <div class="metrics">
          ...
          <div class="metric"><span class="m-label">Sequ\xEAncia</span><span class="m-val blood" id="dashStreak">0</span><span class="m-sub" id="dashStreakSub">dias</span></div>
          <div class="metric"><span class="m-label">M\xE9dia</span><span class="m-val" id="dashAvg">\u2014</span><span class="m-sub">de 7</span></div>
    ...
    <div class="banner" id="dashBanner">Comece o primeiro exerc\xEDcio do dia para abrir o placar.</div>

    <div class="card hero" id="exerciseCard">
      <div class="meta-row">
        <span class="badge" id="categoryBadge">Racioc\xEDnio</span>
      ...
      <textarea id="answerInput" placeholder="Escreva sua resposta aqui. Clique em Iniciar antes de come\xE7ar." disabled></textarea>
      ...
      <div class="session-done" id="sessionDone" style="display:none;">
        ...
        <h3 id="sdTitle">Voc\xEA respondeu todas desta vez</h3>
        <p id="sdText"></p>
        <div class="btn-row">
          <button class="btn-gold" id="sdContinue">Continuar agora</button>
          <button class="btn-ghost" id="sdRest">Esperar a pr\xF3xima sess\xE3o</button>
        </div>
        <div id="sdLoading" style="display:none;">
          <div class="loading-wrap"><span class="spin7" id="spinLote"></span><span class="lbl">Preparando quest\xF5es novas</span></div>
          <div class="prog-wrap">
        ...
        <div class="btn-row" id="sdRevisarRow" style="display:none; margin-top:12px;">
          <button class="btn-ghost" id="sdRevisar">Revisar exerc\xEDcios j\xE1 resolvidos</button>
        </div>
      </div>
      ...
      <div class="result" id="resultSection" style="display:none;">
        ...
        <h4 style="margin-top:14px;">Resposta / crit\xE9rio</h4>
        <p class="answer-text" id="answerText"></p>
        <div id="fallbackRate" style="display:none;">
          <div class="rate-label">N\xE3o consegui avaliar automaticamente. Como voc\xEA chegou nessa resposta?</div>
          <div class="rate-row">
            <button class="rate-option" data-band="4"><strong>Com convic\xE7\xE3o</strong> \u2014 direto, sem "acho que", e bateu com o crit\xE9rio.</button>
            <button class="rate-option" data-band="3"><strong>Hesitando</strong> \u2014 cheguei l\xE1, mas testando e mudando de ideia.</button>
            <button class="rate-option" data-band="0"><strong>Errei</strong> \u2014 ou n\xE3o fechei, mesmo tentando.</button>
          </div>
        </div>
        <div class="btn-row" id="treinoNextRow" style="margin-top:16px; display:none;">
          <button class="btn-gold" id="treinoNext">Pr\xF3ximo exerc\xEDcio</button>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="view" id="viewLeis">
    <header>
      <div class="eyebrow">Gurdjieff \xB7 As leis fundamentais</div>
      <h1>Domine os 3 Poderes</h1>
      <div class="sub-h">As leis que governam fen\xF4menos, processos e resultados</div>
    </header>
    ...
    <div class="lock-teaser" id="leisLockBanner">
      ...
      <div class="body">
        ...
        <p>Os cinco pilares do livro completos: Lei de Tr\xEAs, Lei da Oitava, Lei do Retorno, os Tr\xEAs Centros, e os Quatro Estados de consci\xEAncia.</p>
        <div class="btn-row" style="margin-top:0;">
    ...
    <div id="leisIndex">
      <div class="banner" id="leisBanner">Cinco m\xF3dulos. Estude o resumo, depois responda. O que voc\xEA acerta sai da lista.</div>
      <div class="mod-list" id="modList"></div>
    </div>

    <div id="leisModulo" style="display:none;">
      <button class="back-link" id="leisBack">\u2190 voltar aos m\xF3dulos</button>
      <div class="card hero">
        <div class="meta-row">
          <span class="badge raciocinio" id="modBadge">Lei de Tr\xEAs</span>
        ...
        <div class="result" id="modResult" style="display:none;">
          ...
          <h4>Resposta / crit\xE9rio</h4>
          <p class="answer-text" id="modAnswer"></p>
          <div id="modFallback" style="display:none;">
            <div class="rate-label">Avalie voc\xEA mesmo: voc\xEA acertou o crit\xE9rio?</div>
            <div class="rate-row">
              <button class="rate-option" data-mod="1"><strong>Acertei</strong> \u2014 bateu com o crit\xE9rio.</button>
              <button class="rate-option" data-mod="0"><strong>N\xE3o acertei</strong> \u2014 ficou fora.</button>
            </div>
          </div>
          <div class="btn-row" id="modNextRow" style="margin-top:14px;">
            <button class="btn-gold" id="modNext">Pr\xF3ximo</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="leisDone" style="display:none;">
      <button class="back-link" id="leisBack2">\u2190 voltar aos m\xF3dulos</button>
      <div class="card">
        <div class="session-done">
          <div class="sd-glyph" id="doneGlifo">\u25B3</div>
          <h3>M\xF3dulo conclu\xEDdo</h3>
          <p id="doneText"></p>
          <div class="btn-row">
        <button class="btn-gold" id="doneGerar">Gerar quest\xF5es novas deste m\xF3dulo</button>
        <button class="btn-ghost" id="doneBack">Voltar aos m\xF3dulos</button>
      </div>
      <div id="doneLoading" class="loading-wrap" style="display:none;"><span class="spin7" id="spinDone"></span><span class="lbl">Criando quest\xF5es in\xE9ditas</span></div>
  ...
  <section class="view" id="viewEnea">
    ...
    <div id="eneaIntro">
      <div class="card">
        <p class="resumo" style="margin-bottom:18px;">Este n\xE3o \xE9 o eneagrama de personalidade dos nove tipos. \xC9 o de Gurdjieff: tr\xEAs for\xE7as e sete etapas. A primeira parte encontra qual dos seus tr\xEAs centros comanda. A segunda encontra em que nota da oitava o seu processo costuma quebrar. Dezesseis perguntas, uns quatro minutos.</p>
        <div class="btn-row"><button class="btn-primary" id="eneaStart">Come\xE7ar o teste</button></div>
        <div id="eneaPrevWrap" style="display:none; margin-top:16px; text-align:center;">
          <button class="btn-ghost" id="eneaSeePrev">Ver meu \xFAltimo resultado</button>
        </div>
      </div>
    </div>
    ...
    <div id="eneaQuiz" style="display:none;">
      <div class="card hero">
        ...
        <div class="meta-row">
          <span class="badge influencia" id="eneaPart">Parte 1 \xB7 Os tr\xEAs centros</span>
    ...
    <div id="eneaResult" style="display:none;">
      <div class="card">
        ...
        <div id="eneaGate" class="gate-card" style="display:none;">
          <p class="gate-lead">Sua ficha completa est\xE1 pronta: a origem da quebra, o cruzamento com os tr\xEAs centros e o que fazer a partir disso. Informe seu email pra liberar agora e receber tudo em PDF.</p>
          <div class="gate-row">
          ...
          <button class="btn-gold" id="gateSubmit" style="width:100%;">Liberar minha an\xE1lise completa</button>
          <div id="gateMsg" class="sd-aviso" style="display:none; margin-top:12px;"></div>
          <p class="gate-fine">Sem spam. S\xF3 o relat\xF3rio, e o que vier depois sobre o treino.</p>
        </div>
        ...
        <div class="anam">
          ...
          <div class="ficha-glossario">
            <b>O que significa cada campo:</b> Fun\xE7\xE3o \xE9 o que esse centro faz por voc\xEA. Alimento \xE9 o que ele processa pra funcionar bem. Sede de comando \xE9 onde ele fica baseado no corpo. Densidade vem da cosmologia do livro, um n\xFAmero que mede o qu\xE3o sutil \xE9 a mat\xE9ria que esse centro usa, quanto menor o n\xFAmero, mais fino; "material solar" significa que ele opera numa mat\xE9ria t\xE3o fina quanto a do pr\xF3prio Sol, nesse sistema. \xCAxito \xE9 o resultado que ele entrega quando funciona bem. Desempenho \xE9 a qualidade que ele desenvolve com o uso. Maior revela\xE7\xE3o \xE9 o insight mais alto que ele pode te dar.
          </div>
          ...
          <h4 style="margin-top:22px;">Distribui\xE7\xE3o dos tr\xEAs centros</h4>
        ...
        <div class="anam">
          ...
          <div class="bloco sintoma"><div class="rot">Como isso aparece em voc\xEA</div><p id="anamNotaQuebra"></p></div>
          <div class="bloco origem"><div class="rot">Origem prov\xE1vel</div><p id="anamNotaOrigem"></p></div>
          <div class="bloco correcao"><div class="rot">Corre\xE7\xE3o</div><p id="anamNotaCorrecao"></p></div>
          <p id="anamCritico"></p>
        </div>
        ...
        <div class="anam">
          <h4>O que \xE9 o choque consciente</h4>
          <p>Na escala musical faltam os semitons em dois lugares: entre mi e f\xE1, e entre si e d\xF3. N\xE3o \xE9 escolha de ningu\xE9m, \xE9 o espectro dispon\xEDvel na natureza. Nesses dois intervalos o processo perde o apoio que tinha nos outros e tende a desviar do rumo original, e o livro \xE9 claro que isso acontece por vontade da lei, n\xE3o por falha de car\xE1ter.</p>
          <p><strong>Choque consciente \xE9 a interven\xE7\xE3o que se aplica exatamente ali.</strong> Gurdjieff o definia como uma adi\xE7\xE3o de energia extra, feita de prop\xF3sito e fora do autom\xE1tico, para compensar essa tend\xEAncia natural de desvio. Tr\xEAs coisas o distinguem de simplesmente se esfor\xE7ar mais: ele \xE9 <strong>deliberado</strong>, ou seja, voc\xEA sabe que est\xE1 aplicando; \xE9 <strong>localizado</strong>, entra no ponto cr\xEDtico e n\xE3o espalhado pelo processo inteiro; e \xE9 <strong>extra</strong>, acima do que o processo pediria em condi\xE7\xE3o normal.</p>
          <p>Na pr\xE1tica, muda de forma conforme o ponto. No primeiro ponto cr\xEDtico, entre mi e f\xE1, o esfor\xE7o \xE9 de pensamento: exigir de si mais alternativas antes de permitir a decis\xE3o, quando a pressa e o rel\xF3gio pedem o contr\xE1rio. No segundo, entre si e d\xF3, o esfor\xE7o \xE9 de fechamento: nomear o pr\xF3ximo passo, o respons\xE1vel e a data, quando a sensa\xE7\xE3o \xE9 de que o trabalho j\xE1 acabou. Sem o choque, o desvio nesses pontos n\xE3o \xE9 acidente, \xE9 o comportamento padr\xE3o.</p>
        </div>

        <div class="btn-row" style="margin-top:26px;">
          <button class="btn-gold" id="eneaPdf">Baixar PDF da an\xE1lise</button>
        </div>
        ...
        <div class="card" style="margin-top:26px; border-color:var(--brass-dim);">
          <div style="text-align:center; margin-bottom:16px;">
            ...
            <div style="font-size:12.5px; color:var(--dim); line-height:1.5;" id="pvPersonalTxt">O treino di\xE1rio trabalha exatamente onde voc\xEA trava, todo dia.</div>
          </div>
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
            <div style="border:1px solid var(--rule); border-radius:8px; padding:14px 10px; text-align:center;">
              ...
              <div style="font-size:10px; color:var(--dim); margin-bottom:10px;">por m\xEAs</div>
            ...
            <div style="border:1.5px solid var(--brass); border-radius:8px; padding:14px 10px; text-align:center; position:relative; background:rgba(201,162,75,0.06);">
              <div style="position:absolute; top:-9px; left:50%; transform:translateX(-50%); background:var(--brass); color:var(--ink); font-family:'IBM Plex Mono',monospace; font-size:8px; text-transform:uppercase; letter-spacing:.05em; padding:2px 8px; border-radius:10px; white-space:nowrap;">2 meses gr\xE1tis</div>
              ...
              <div style="font-size:10px; color:var(--dim); margin-bottom:10px;">menos de R$31/m\xEAs</div>
  ...
  <section class="view" id="viewPerf">
    <header>
      <div class="eyebrow">Vis\xE3o consolidada</div>
      <h1>Performance</h1>
      <div class="sub-h">Onde voc\xEA est\xE1 forte e o que precisa melhorar</div>
    </header>
    ...
    <div class="card">
      ...
      <div class="metrics" style="border:1px solid var(--rule); border-radius:8px; overflow:hidden; grid-template-columns:repeat(4,1fr);">
        ...
        <div class="metric"><span class="m-label">Sequ\xEAncia</span><span class="m-val blood" id="pfStreak">0</span><span class="m-sub">dias</span></div>
        <div class="metric"><span class="m-label">Eneagrama</span><span class="m-val" id="pfEnea" style="font-size:14px;">\u2014</span><span class="m-sub" id="pfEneaSub">n\xE3o feito</span></div>
      </div>
    </div>

    <div class="card">
      <div class="card-title">Pontos a melhorar</div>
      <ul class="melhora-list" id="melhoraList"><li>Responda alguns exerc\xEDcios para eu mapear seus pontos fracos.</li></ul>
    </div>

    <div class="card">
      <div class="card-title">Os tr\xEAs eixos</div>
    ...
    <div class="card">
      ...
      <div class="btn-row" style="margin-bottom:16px;">
        ...
        <button class="tab-btn" data-pane="Hist">Hist\xF3rico</button>
        <button class="tab-btn" data-pane="Io">Backup</button>
      </div>
      <div class="pane active" id="paneRank">
        <div class="btn-row" style="margin-bottom:14px;">
          <button class="tab-btn active" id="tabSessao">Por sess\xE3o</button>
          <button class="tab-btn" id="tabDia">Por dia</button>
        </div>
        <div id="rankingWrap"><div class="empty-state">Ainda sem sess\xF5es pra ranquear.</div></div>
        <div class="axis-note">Posi\xE7\xF5es 3, 6 e 9 v\xEAm em dourado, o eixo de controle por tr\xE1s do ciclo 1-2-4-8-7-5.</div>
      </div>
    ...
    <div class="card">
      <div class="card-title">Exerc\xEDcio sob medida</div>
      <div class="io-help" style="margin-bottom:14px;">Gera uma quest\xE3o nova mirando o eixo em que voc\xEA est\xE1 mais fraco, evitando os temas que j\xE1 apareceram.</div>
      <div class="btn-row"><button class="btn-gold" id="genBtn">Gerar exerc\xEDcio no meu ponto fraco</button></div>
      <div id="genLoading" class="loading-wrap" style="display:none;"><span class="spin7" id="spinGen"></span><span class="lbl">Criando exerc\xEDcio sob medida</span></div>
    </div>
  </section>
...
<script>
/* ===== Banco do Treino Di\xE1rio ===== */
const EXERCISES = [
  { id:'livro-1-tijolo', cat:'raciocinio', catLabel:'Racioc\xEDnio', type:'livre', fonte:'Livro \xB7 1\xBA',
    concept:'\xE1lgebra simples escondida em enunciado cotidiano',
    prompt:'Num prato da balan\xE7a, um tijolo inteiro. No outro, meio tijolo mais um peso de 1kg. A balan\xE7a fica nivelada. Quanto pesa o tijolo inteiro?',
    answer:'2 kg. Se o tijolo inteiro equilibra com meio tijolo mais 1kg, meio tijolo pesa 1kg, logo o inteiro pesa 2kg.' },
  { id:'livro-2-prateleiras', cat:'raciocinio', catLabel:'Racioc\xEDnio', type:'livre', fonte:'Livro \xB7 2\xBA',
    concept:'extrair informa\xE7\xE3o m\xE1xima de uma \xFAnica medi\xE7\xE3o',
    prompt:'Onze prateleiras, dez bolas iguais em cada. Todas de 1kg, exceto as de uma prateleira, que pesam 900g. Com UMA \xFAnica pesagem, como descobrir qual \xE9?',
    answer:'Pegue 1 bola da prateleira 1, 2 da prateleira 2, e assim at\xE9 10 da prateleira 10, nenhuma da 11. Pese as 55 juntas. O quanto faltar para 55kg, em m\xFAltiplos de 100g, aponta a prateleira. Se der 55kg cravado, \xE9 a 11.' },
  { id:'livro-3-vinho', cat:'raciocinio', catLabel:'Racioc\xEDnio', type:'multipla', fonte:'Livro \xB7 3\xBA',
    concept:'simetria de troca entre dois conjuntos',
    prompt:'Uma colher de vinho vai para a \xE1gua e mistura. A mesma colher, cheia da mistura, volta para o vinho. H\xE1 mais vinho na \xE1gua ou mais \xE1gua no vinho?',
    options:['Mais vinho na \xE1gua','Mais \xE1gua no vinho','S\xE3o iguais'], correctIndex:2,
    answer:'S\xE3o iguais. Cada copo termina com o volume do come\xE7o, ent\xE3o o que falta de um l\xEDquido foi substitu\xEDdo pelo mesmo volume do outro. \xC9 a analogia das duas cidades trocando quarenta passageiros.' },
  { id:'livro-4-populacao', cat:'discernimento', catLabel:'Discernimento', type:'multipla', fonte:'Livro \xB7 4\xBA',
    concept:'no\xE7\xE3o de grandeza pelo sentimento',
    prompt:'Sem calcular, pelo sentimento: toda a popula\xE7\xE3o do mundo reunida numa s\xF3 aglomera\xE7\xE3o, a 4 pessoas por metro quadrado, ocuparia que \xE1rea?',
    options:['A Grande Belo Horizonte, cerca de 40 por 40 km','Todo o estado do Amazonas','Metade do territ\xF3rio brasileiro'], correctIndex:0,
    answer:'A Grande Belo Horizonte, uns 40 por 40 km. S\xE3o 1,6 bilh\xE3o de metros quadrados, e a 4 por metro cabem 6,4 bilh\xF5es. O ponto do livro \xE9 o nosso sentimento exagerado de escassez.' },
  { id:'livro-5-triade', cat:'influencia', catLabel:'Influ\xEAncia', type:'multipla', fonte:'Livro \xB7 5\xBA',
    concept:'dom\xEDnio da tr\xEDade Mente, Emo\xE7\xE3o, Corpo',
    prompt:'Na tabela das tr\xEDades: Intelig\xEAncia para a Mente, Coragem para a Emo\xE7\xE3o, e para o Corpo?',
    options:['Disciplina','Liberdade','Resist\xEAncia'], correctIndex:1,
    answer:'Liberdade. A tr\xEDade \xE9 Intelig\xEAncia, Coragem, Liberdade. Assim como Vis\xE3o, Paix\xE3o, A\xE7\xE3o. E Pensamento, Sentimento, Movimento.' },
  { id:'livro-6-polar', cat:'raciocinio', catLabel:'Racioc\xEDnio', type:'multipla', fonte:'Livro \xB7 6\xBA',
    concept:'geometria celeste e imagina\xE7\xE3o espacial',
    prompt:'Voc\xEA est\xE1 na Latitude Zero, na linha do Equador. A que altura no c\xE9u ver\xE1 a Estrela Polar?',
    options:['Na vertical, acima da cabe\xE7a','A meia altura do c\xE9u','No horizonte'], correctIndex:2,
    answer:'No horizonte. A altura da Polar no c\xE9u \xE9 igual \xE0 sua latitude. No Equador, latitude zero, ela aparece rente ao horizonte norte.' },
  { id:'livro-7-lua', cat:'raciocinio', catLabel:'Racioc\xEDnio', type:'multipla', fonte:'Livro \xB7 7\xBA',
    concept:'posi\xE7\xE3o relativa e fases da lua',
    prompt:'Voc\xEA v\xEA a Terra \xE0 sua frente, o Sol \xE0 esquerda e V\xEAnus \xE0 direita. \xC9 inverno no hemisf\xE9rio sul e a Lua est\xE1 em quarto minguante. Onde est\xE1 a Lua?',
    options:['\xC0 esquerda da Terra','\xC0 direita da Terra','\xC0 sua frente, entre voc\xEA e a Terra'], correctIndex:2,
    answer:'\xC0 sua frente, entre voc\xEA e a Terra. A fase depende da posi\xE7\xE3o relativa entre Sol, Terra e Lua, e essa combina\xE7\xE3o a coloca nesse ponto.' },
  { id:'livro-8-tabuleiro', cat:'discernimento', catLabel:'Discernimento', type:'multipla', fonte:'Livro \xB7 8\xBA',
    concept:'crescimento exponencial e fal\xEAncia por falta de no\xE7\xE3o de grandeza',
    prompt:'Um gr\xE3o de trigo na primeira casa do tabuleiro, dobrando e acumulando at\xE9 a casa 64. Quantos gr\xE3os no total?',
    options:['Cerca de mil','Cerca de um bilh\xE3o','Mais de 18 quintilh\xF5es'], correctIndex:2,
    answer:'Mais de 18 quintilh\xF5es. S\xF3 na casa 40 j\xE1 passa de um trilh\xE3o. O rei aceitou e faliu em menos de trinta segundos, por falta de no\xE7\xE3o de grandeza.' },
  { id:'livro-mago', cat:'discernimento', catLabel:'Discernimento', type:'livre', fonte:'Livro \xB7 Gurdjieff',
    concept:'reconhecer condicionamento e hipnose social',
    prompt:'No conto do Mago e seu Rebanho, os carneiros s\xE3o hipnotizados a se acharem le\xF5es e magos, e passam a esperar o abate com calma. Qual a li\xE7\xE3o pr\xE1tica disso na sua vida profissional hoje?',
    answer:'Crit\xE9rio: reconhecer que a hipnose funciona porque d\xE1 uma identidade lisonjeira que substitui a percep\xE7\xE3o do pr\xF3prio interesse. Aplica\xE7\xE3o: notar quando um t\xEDtulo, elogio ou discurso de prop\xF3sito serve para voc\xEA aceitar algo que n\xE3o te serve. Resposta forte nomeia uma situa\xE7\xE3o concreta.' },
  { id:'interruptores', cat:'discernimento', catLabel:'Discernimento', type:'livre', fonte:'Cl\xE1ssico',
    concept:'usar vari\xE1vel n\xE3o \xF3bvia para multiplicar informa\xE7\xE3o',
    prompt:'Tr\xEAs interruptores fora de uma sala fechada. Um acende a l\xE2mpada l\xE1 dentro. Voc\xEA s\xF3 pode entrar uma vez. Como descobrir qual \xE9?',
    answer:'Ligue o 1, espere alguns minutos, desligue e ligue o 2. Entre: acesa \xE9 o 2, apagada e quente \xE9 o 1, apagada e fria \xE9 o 3. A informa\xE7\xE3o extra vem do calor.' },
  { id:'decisao-parcial', cat:'discernimento', catLabel:'Discernimento', type:'livre', fonte:'Aplicado',
    concept:'crit\xE9rio de decis\xE3o sob informa\xE7\xE3o incompleta',
    prompt:'Informa\xE7\xE3o importante mas incompleta, apontando forte numa dire\xE7\xE3o sem ser prova. Voc\xEA precisa decidir hoje. Qual o crit\xE9rio: esperar mais dado ou agir?',
    answer:'Crit\xE9rio: o custo de esperar \xE9 maior que o custo de errar com o dado atual? Se sim, decida agora. Discernimento \xE9 decidir com informa\xE7\xE3o suficiente, n\xE3o perfeita.' },
  { id:'sintese-pitch', cat:'influencia', catLabel:'Influ\xEAncia', type:'livre', fonte:'Aplicado',
    concept:'s\xEDntese persuasiva com gancho na frente',
    prompt:'Em at\xE9 30 palavras: por que uma marca deveria investir num evento pontual em vez de m\xEDdia tradicional? Sem "acho que". Direto.',
    answer:'Crit\xE9rio: come\xE7ou pela conclus\xE3o, sem amaciamento, em torno de 30 palavras. O conte\xFAdo \xE9 livre, a estrutura \xE9 o que vale.' },
  { id:'objecao-rapida', cat:'influencia', catLabel:'Influ\xEAncia', type:'livre', fonte:'Aplicado',
    concept:'sustentar posi\xE7\xE3o sob press\xE3o hier\xE1rquica',
    prompt:'Algu\xE9m de hierarquia acima discorda da sua proposta na frente de todos. Em uma frase, sem justificar demais, como voc\xEA responde mantendo a posi\xE7\xE3o?',
    answer:'Crit\xE9rio: afirma a posi\xE7\xE3o, d\xE1 um motivo objetivo, n\xE3o pede desculpa por discordar. Frase longa aqui \xE9 inseguran\xE7a disfar\xE7ada de educa\xE7\xE3o.' },
  { id:'abertura-reuniao', cat:'influencia', catLabel:'Influ\xEAncia', type:'multipla', fonte:'Aplicado',
    concept:'ordem de abertura que gera influ\xEAncia',
    prompt:'Qual abertura gera mais influ\xEAncia numa negocia\xE7\xE3o tensa?',
    options:['Contexto detalhado primeiro, conclus\xE3o no final','Conclus\xE3o direta primeiro, sustenta\xE7\xE3o depois','Agradecimentos e elogios, depois o assunto'], correctIndex:1,
    answer:'Conclus\xE3o primeiro, sustenta\xE7\xE3o depois. Gancho antes de contexto. Se a pessoa s\xF3 ouvir a primeira frase, j\xE1 precisa saber sua posi\xE7\xE3o.' }
];

/* ===== M\xF3dulos das Leis ===== */
const MODULOS = [
  {
    id:'lei-tres', nome:'A Lei de Tr\xEAs', sub:'Governa os fen\xF4menos', glifo:'\u25B3',
    contexto:'A Lei de Tr\xEAs de Gurdjieff: todo fenomeno se decompoe em forca positiva (sutil, energia), negativa (densa, materia) e conciliadora (a chave, onde mora a complexidade). Exercicios identificam as tres forcas em fenomenos variados e aplicam a triade a situacoes reais de negocio e vida.',
    resumo:'Todo fen\xF4meno se decomp\xF5e em tr\xEAs for\xE7as: a positiva (sutil, pura energia), a negativa (densa, pura mat\xE9ria) e a conciliadora, que harmoniza as duas. Nenhum fen\xF4meno vem \xE0 exist\xEAncia sem a participa\xE7\xE3o solene das tr\xEAs. A for\xE7a conciliadora \xE9 sempre a chave: \xE9 nela que mora a complexidade e a solu\xE7\xE3o.',
    itens:[
      { f:'Livro', type:'multipla', prompt:'Concreto = cimento + \xE1gua + agregados. Qual \xE9 a for\xE7a conciliadora?', options:['Cimento','\xC1gua','Agregados'], correctIndex:1,
        answer:'A \xE1gua. O cimento \xE9 a for\xE7a positiva, os agregados a negativa, e a \xE1gua concilia as duas num campo de harmonia.' },
      { f:'Livro', type:'multipla', prompt:'Na tr\xEDade Produ\xE7\xE3o, Distribui\xE7\xE3o e Consumo, onde mora a complexidade real?', options:['Na produ\xE7\xE3o','Na distribui\xE7\xE3o','No consumo'], correctIndex:1,
        answer:'Na distribui\xE7\xE3o, a for\xE7a conciliadora. Produzir e consumir \xE9 simples. Toda a complexidade est\xE1 no meio.' },
      { f:'Livro', type:'multipla', prompt:'Governo = Executivo, Judici\xE1rio e Legislativo. Qual \xE9 a conciliadora?', options:['Executivo','Judici\xE1rio','Legislativo'], correctIndex:1,
        answer:'O Judici\xE1rio. Assim como na tr\xEDade da disputa, tudo depende do juiz.' },
      { f:'Livro', type:'multipla', prompt:'Ser humano = Mente, Emo\xE7\xE3o e Corpo. Qual \xE9 a for\xE7a conciliadora?', options:['A mente','A emo\xE7\xE3o','O corpo'], correctIndex:1,
        answer:'A emo\xE7\xE3o. Por isso o "mente s\xE3 em corpo s\xE3o" \xE9 tratado no livro como crime contra a humanidade: apaga justamente a for\xE7a do meio.' },
      { f:'Livro', type:'multipla', prompt:'Para extinguir o fogo, que \xE9 combust\xEDvel + oxig\xEAnio + calor, o que se faz?', options:['Aumentar um dos tr\xEAs','Eliminar um dos tr\xEAs','Equilibrar os tr\xEAs'], correctIndex:1,
        answer:'Eliminar um dos tr\xEAs. Abafar remove o oxig\xEAnio e o fen\xF4meno deixa de existir. Nenhum fen\xF4meno sobrevive sem as tr\xEAs for\xE7as.' },
      { f:'Livro', type:'multipla', prompt:'Toda tecnologia tem tr\xEAs for\xE7as. Quais s\xE3o?', options:['Objetivo, estrat\xE9gia e t\xE9cnica','Ideia, dinheiro e execu\xE7\xE3o','Pessoa, processo e ferramenta'], correctIndex:0,
        answer:'Objetivo (o qu\xEA e por qu\xEA), estrat\xE9gia (como e quando) e t\xE9cnica (com qu\xEA e onde). Todo profissional vende um saber, e todo saber \xE9 um evento tecnol\xF3gico.' },
      { f:'Livro', type:'multipla', prompt:'No \xE1tomo, quais s\xE3o as tr\xEAs for\xE7as?', options:['N\xFAcleo, campo eletromagn\xE9tico e el\xE9trons','Pr\xF3tons, n\xEAutrons e el\xE9trons','Massa, carga e \xF3rbita'], correctIndex:0,
        answer:'N\xFAcleo (positiva), campo eletromagn\xE9tico (conciliadora) e el\xE9trons (negativa). O campo \xE9 o que sustenta a rela\xE7\xE3o entre os outros dois.' },
      { f:'Livro', type:'multipla', prompt:'No Sistema Solar, qual elemento ocupa a posi\xE7\xE3o conciliadora?', options:['O Sol','O sistema planet\xE1rio','Cada um dos planetas'], correctIndex:1,
        answer:'O sistema planet\xE1rio. O Sol \xE9 a for\xE7a positiva, os planetas individualmente s\xE3o a negativa, e o sistema como organiza\xE7\xE3o \xE9 o que concilia.' },
      { f:'Livro', type:'multipla', prompt:'Na tr\xEDade da fam\xEDlia, quem ocupa a posi\xE7\xE3o conciliadora?', options:['O pai','O filho','A m\xE3e'], correctIndex:1,
        answer:'O filho. E o livro observa: a maior parte dos problemas do casal costuma passar por ali. Num casal sem filhos, a concilia\xE7\xE3o vem do amor, de um sonho em comum ou da conviv\xEAncia.' },
      { f:'Livro', type:'multipla', prompt:'O menino da hist\xF3ria dizia saber fazer tr\xEAs coisas: pensar, esperar e jejuar. Qual delas \xE9 a conciliadora?', options:['Pensar','Esperar','Jejuar'], correctIndex:1,
        answer:'Esperar, que corresponde ao centro emocional. Pensar \xE9 o mental, jejuar \xE9 o corporal. E foi essa capacidade que garantiu ao menino trabalho, fam\xEDlia e prosperidade.' },
      { f:'Aplicado', type:'multipla', prompt:'Numa venda, considerando produto, vendedor e cliente, onde est\xE1 a for\xE7a conciliadora?', options:['No produto','No vendedor','No cliente'], correctIndex:1,
        answer:'No vendedor. Produto e cliente existem independentemente; \xE9 o vendedor que concilia os dois. E por isso \xE9 ali que mora toda a complexidade da opera\xE7\xE3o comercial.' },
      { f:'Aplicado', type:'multipla', prompt:'Num evento, considerando artista, produ\xE7\xE3o e p\xFAblico, quem concilia?', options:['O artista','A produ\xE7\xE3o','O p\xFAblico'], correctIndex:1,
        answer:'A produ\xE7\xE3o. O artista \xE9 a for\xE7a positiva, o p\xFAblico a negativa, e a produ\xE7\xE3o \xE9 o que faz os dois se encontrarem. Falhou a produ\xE7\xE3o, o fen\xF4meno n\xE3o acontece, por melhores que sejam os outros dois.' },
      { f:'Aplicado', type:'multipla', prompt:'Na comunica\xE7\xE3o, considerando emissor, canal e receptor, onde est\xE1 a conciliadora?', options:['No emissor','No canal','No receptor'], correctIndex:1,
        answer:'No canal, que inclui o meio, o tom e o momento. \xC9 por isso que a mesma mensagem funciona num contexto e destr\xF3i em outro.' },
      { f:'Aplicado', type:'multipla', prompt:'Num time de futebol, entre ataque, meio-campo e defesa, quem concilia?', options:['O ataque','O meio-campo','A defesa'], correctIndex:1,
        answer:'O meio-campo. Time que ganha jogo dif\xEDcil normalmente ganha no meio, n\xE3o nas pontas. \xC9 a for\xE7a que organiza a rela\xE7\xE3o entre as outras duas.' },
      { f:'Aplicado', type:'multipla', prompt:'Uma equipe entrega no prazo mas com qualidade ruim. Pela Lei de Tr\xEAs, onde voc\xEA procura o problema primeiro?', options:['Na capacidade das pessoas','No processo que liga pessoas e entrega','Na defini\xE7\xE3o do resultado esperado'], correctIndex:1,
        answer:'No processo, que \xE9 a for\xE7a conciliadora entre quem faz e o que se entrega. \xC9 l\xE1 que mora a complexidade, e \xE9 l\xE1 que quase sempre est\xE1 a falha real.' },
      { f:'Aplicado', type:'multipla', prompt:'Qual destas afirma\xE7\xF5es contradiz a Lei de Tr\xEAs?', options:['Toda tr\xEDade tem uma for\xE7a que harmoniza as outras duas','Um fen\xF4meno pode existir com apenas duas for\xE7as, desde que fortes','A conciliadora \xE9 onde costuma estar o problema'], correctIndex:1,
        answer:'A de que um fen\xF4meno pode existir com duas for\xE7as. Nenhum fen\xF4meno vem \xE0 exist\xEAncia sem a participa\xE7\xE3o solene das tr\xEAs. Ver o mundo em pares \xE9 justamente a vis\xE3o dual que o livro combate.' },
      { f:'Aplicado', type:'livre', prompt:'Pegue um problema real da sua semana e decomponha nas tr\xEAs for\xE7as. Qual delas \xE9 a conciliadora, e o problema est\xE1 nela?',
        answer:'Crit\xE9rio: identificou as tr\xEAs for\xE7as com clareza, nomeou a conciliadora, e verificou se \xE9 ali que o problema mora. Resposta forte \xE9 espec\xEDfica, n\xE3o gen\xE9rica.' },
      { f:'Aplicado', type:'livre', prompt:'Aplique a tr\xEDade objetivo, estrat\xE9gia e t\xE9cnica a um projeto seu em andamento agora.',
        answer:'Crit\xE9rio: separou com clareza o qu\xEA/por qu\xEA (objetivo), o como/quando (estrat\xE9gia) e o com qu\xEA/onde (t\xE9cnica), sem misturar os tr\xEAs.' },
      { f:'Aplicado', type:'livre', prompt:'Aponte uma situa\xE7\xE3o em que voc\xEA vinha enxergando s\xF3 dois lados. Qual era a terceira for\xE7a que voc\xEA n\xE3o estava vendo?',
        answer:'Crit\xE9rio: nomeia a vis\xE3o dual anterior e identifica com precis\xE3o a for\xE7a que faltava. O livro trata a vis\xE3o dual como ferramenta de domina\xE7\xE3o justamente por esconder a terceira for\xE7a.' },
      { f:'Aplicado', type:'livre', prompt:'Numa negocia\xE7\xE3o travada sua, quem ou o que ocupa a posi\xE7\xE3o conciliadora? Ela est\xE1 sendo trabalhada, ou voc\xEAs est\xE3o s\xF3 empurrando as duas pontas?',
        answer:'Crit\xE9rio: identifica a conciliadora concreta (uma pessoa, um documento, um prazo, um intermedi\xE1rio) e avalia honestamente se ela est\xE1 recebendo aten\xE7\xE3o. Negocia\xE7\xE3o travada quase sempre \xE9 conciliadora abandonada.' }
    ]
  },
  {
    ...
    resumo:'Tudo que existe vibra, e toda vibra\xE7\xE3o obedece ao ciclo de sete. Na escala musical faltam os semitons entre mi e f\xE1 e entre si e d\xF3: s\xE3o os dois pontos cr\xEDticos de todo processo, onde ele tende a desviar do rumo. Nesses pontos \xE9 preciso o que Gurdjieff chamava de choque consciente, um acr\xE9scimo intencional de energia.',
    itens:[
      { f:'Livro', type:'multipla', prompt:'Onde est\xE3o os dois pontos cr\xEDticos da escala?', options:['Entre d\xF3 e r\xE9, e entre sol e l\xE1','Entre mi e f\xE1, e entre si e d\xF3','Entre r\xE9 e mi, e entre l\xE1 e si'], correctIndex:1,
        answer:'Entre mi e f\xE1, e entre si e d\xF3. S\xE3o os intervalos onde n\xE3o coube o semitom, e \xE9 ali que todo processo amea\xE7a sair do rumo.' },
      { f:'Livro', type:'multipla', prompt:'O que \xE9 o choque consciente?', options:['Uma pausa para descansar','Uma adi\xE7\xE3o intencional de energia extra para manter o rumo','Uma mudan\xE7a de objetivo'], correctIndex:1,
        answer:'Uma adi\xE7\xE3o de energia extra, feita de prop\xF3sito, para compensar a tend\xEAncia natural de desvio nos pontos cr\xEDticos.' },
      { f:'Livro', type:'multipla', prompt:'Na oitava da manifesta\xE7\xE3o humana, a nota D\xF3 equivale a qu\xEA?', options:['Percep\xE7\xE3o','Decis\xE3o','Influ\xEAncia'], correctIndex:0,
        answer:'Percep\xE7\xE3o. Funciona como um radar: recebe os est\xEDmulos dispon\xEDveis no ambiente. \xC9 o in\xEDcio de todo processo.' },
      { f:'Livro', type:'multipla', prompt:'E a nota R\xE9?', options:['Absor\xE7\xE3o ou rea\xE7\xE3o','Racioc\xEDnio','Entusiasmo'], correctIndex:0,
        answer:'Absor\xE7\xE3o ou rea\xE7\xE3o. \xC9 onde a informa\xE7\xE3o entra. Se voc\xEA j\xE1 reage por cima, distorce antes de entender.' },
      { f:'Livro', type:'multipla', prompt:'E a nota F\xE1?', options:['Racioc\xEDnio','Discernimento, a decis\xE3o com coragem','Manifesta\xE7\xE3o'], correctIndex:1,
        answer:'Discernimento. Aqui a escala deixa de ser mental e vira emocional. \xC9 onde se escolhe, e escolher exige coragem.' },
      { f:'Livro', type:'multipla', prompt:'E a nota Sol?', options:['Discernimento','Entusiasmo, motiva\xE7\xE3o, vontade','Influ\xEAncia'], correctIndex:1,
        answer:'Entusiasmo. \xC9 onde se concentra todo o g\xE1s necess\xE1rio para a etapa seguinte. Decis\xE3o sem entusiasmo n\xE3o sustenta o processo.' },
      { f:'Livro', type:'multipla', prompt:'E a nota L\xE1?', options:['Manifesta\xE7\xE3o, o pronunciamento','Absor\xE7\xE3o','Percep\xE7\xE3o'], correctIndex:0,
        answer:'Manifesta\xE7\xE3o. \xC9 onde a pessoa mostra o tamanho da sua capacidade, da sua intelig\xEAncia e da sua coragem.' },
      { f:'Livro', type:'multipla', prompt:'E a nota Si, \xFAltima da oitava?', options:['Entusiasmo','Manifesta\xE7\xE3o','Influ\xEAncia'], correctIndex:2,
        answer:'Influ\xEAncia. Se tudo foi bem feito, voc\xEA influencia. E logo depois vem o segundo ponto cr\xEDtico, que exige esfor\xE7o extra para fechar o ciclo.' },
      { f:'Livro', type:'multipla', prompt:'Qual \xE9 a sequ\xEAncia correta da oitava humana?', options:['Percep\xE7\xE3o, absor\xE7\xE3o, racioc\xEDnio, discernimento, entusiasmo, manifesta\xE7\xE3o, influ\xEAncia','Percep\xE7\xE3o, racioc\xEDnio, decis\xE3o, a\xE7\xE3o, an\xE1lise, controle, resultado','Ideia, plano, recurso, execu\xE7\xE3o, controle, revis\xE3o, entrega'], correctIndex:0,
        answer:'D\xF3 percep\xE7\xE3o, R\xE9 absor\xE7\xE3o, Mi racioc\xEDnio, F\xE1 discernimento, Sol entusiasmo, L\xE1 manifesta\xE7\xE3o, Si influ\xEAncia.' },
      { f:'Livro', type:'multipla', prompt:'Na oitava de uma obra (projeto, planejamento, suprimento, execu\xE7\xE3o, controle, an\xE1lise, novas ideias), qual \xE9 o primeiro ponto fraco?', options:['Concluir o planejamento','Concluir o suprimento','Concluir a execu\xE7\xE3o'], correctIndex:1,
        answer:'Concluir o suprimento, entre mi e f\xE1. O segundo ponto fraco \xE9 fazer surgirem novas ideias, entre si e o d\xF3 da pr\xF3xima oitava.' },
      { f:'Livro', type:'multipla', prompt:'Qual experimento cient\xEDfico o livro aponta como demonstra\xE7\xE3o da Lei de Oitava?', options:['A dupla fenda','O prisma de Newton','O p\xEAndulo de Foucault'], correctIndex:1,
      ...
      { f:'Livro', type:'multipla', prompt:'O que acontece quando uma vibra\xE7\xE3o passa da s\xE9tima para a oitava onda?', options:['Ela se extingue','Muda de escala mantendo as caracter\xEDsticas da primeira','Inverte o sentido'], correctIndex:1,
        answer:'Muda de escala mas mant\xE9m as mesmas caracter\xEDsticas da primeira. Por isso o D\xF3 de uma escala tem o mesmo timbre do D\xF3 de todas as outras.' },
      { f:'Aplicado', type:'multipla', prompt:'Um vendedor que faz \xF3tima apresenta\xE7\xE3o mas n\xE3o fecha neg\xF3cio est\xE1 travando em qual nota?', options:['Mi, o racioc\xEDnio','L\xE1, a manifesta\xE7\xE3o','Si, a influ\xEAncia'], correctIndex:2,
        answer:'Si, a influ\xEAncia, e ele para exatamente no segundo ponto cr\xEDtico. Manifestar bem \xE9 L\xE1. Fazer o outro agir depois \xE9 Si, e \xE9 ali que se perde a maioria dos processos comerciais.' },
      { f:'Aplicado', type:'multipla', prompt:'Uma pessoa que decide r\xE1pido demais, sem levantar alternativas, est\xE1 pulando qual etapa?', options:['Mi, o racioc\xEDnio','Sol, o entusiasmo','L\xE1, a manifesta\xE7\xE3o'], correctIndex:0,
        answer:'Mi, o racioc\xEDnio. Sem gerar alternativas suficientes, a decis\xE3o em F\xE1 vira chute, e a motiva\xE7\xE3o em Sol nasce fraca. \xC9 a analogia do enxadrista sob press\xE3o de rel\xF3gio.' },
      { f:'Aplicado', type:'multipla', prompt:'Um projeto seu tem verba aprovada, plano pronto, mas o dinheiro n\xE3o chega e tudo para. Pela oitava da obra, onde est\xE1?', options:['No primeiro ponto cr\xEDtico, concluir o suprimento','No segundo ponto cr\xEDtico, gerar novas ideias','Na execu\xE7\xE3o'], correctIndex:0,
        answer:'No primeiro ponto cr\xEDtico, entre mi e f\xE1. Aprova\xE7\xE3o n\xE3o \xE9 suprimento. E \xE9 justamente ali que a lei empurra o processo para fora do rumo, se ningu\xE9m der o choque consciente.' },
      { f:'Aplicado', type:'multipla', prompt:'Qual destas N\xC3O \xE9 uma manifesta\xE7\xE3o da Lei de Oitava citada no livro?', options:['Os sete dias da semana','O espectro de sete cores','As quatro esta\xE7\xF5es do ano'], correctIndex:2,
        answer:'As quatro esta\xE7\xF5es. O livro cita os dias da semana, as notas musicais, as ondas eletromagn\xE9ticas e o espectro de cores, todos em sete.' },
      { f:'Aplicado', type:'livre', prompt:'Descreva um projeto seu que travou no meio. Em qual nota ele parou, e que choque consciente teria salvado o rumo?',
        answer:'Crit\xE9rio: identificou a nota com precis\xE3o e prop\xF4s uma interven\xE7\xE3o concreta, n\xE3o gen\xE9rica. Reconhecer o ponto cr\xEDtico \xE9 o que separa quem corrige de quem fica nas m\xE3os da sorte.' },
      { f:'Aplicado', type:'livre', prompt:'Aplique as sete notas a um processo comercial seu, do primeiro contato ao fechamento. Onde ele costuma morrer?',
        answer:'Crit\xE9rio: mapeou as sete etapas ao processo real, sem for\xE7ar, e apontou o ponto de perda com honestidade. Resposta forte reconhece se o ponto de perda coincide com um dos dois pontos cr\xEDticos naturais.' },
      { f:'Aplicado', type:'livre', prompt:'Qual processo seu est\xE1 agora exatamente num ponto cr\xEDtico, e que esfor\xE7o extra espec\xEDfico voc\xEA vai aplicar esta semana?',
        answer:'Crit\xE9rio: nomeia o processo, localiza o ponto cr\xEDtico e define uma a\xE7\xE3o concreta com prazo. Choque consciente sem data \xE9 inten\xE7\xE3o, n\xE3o choque.' },
      { f:'Aplicado', type:'livre', prompt:'Voc\xEA chegou at\xE9 L\xE1, se manifestou bem, e mesmo assim n\xE3o houve influ\xEAncia. O que faltou entre uma nota e outra?',
        answer:'Crit\xE9rio: reconhece que entre si e d\xF3 existe um ponto cr\xEDtico e identifica o esfor\xE7o extra que faltou: um pedido expl\xEDcito, um prazo, um pr\xF3ximo passo concreto. Manifestar n\xE3o \xE9 influenciar.' }
    ]
  },
  {
    ...
    resumo:'Toda a\xE7\xE3o corresponde a uma rea\xE7\xE3o igual e de sentido contr\xE1rio. Tudo que se planta, se colhe. \xC9 a lei de causa e efeito, e no s\xEDmbolo do Eneagrama est\xE1 representada pela circunfer\xEAncia, a serpente que engole o pr\xF3prio rabo. Nada do que se faz deixa de ser contabilizado pela natureza.',
    itens:[
      { f:'Livro', type:'multipla', prompt:'No s\xEDmbolo do Eneagrama, a Lei do Retorno \xE9 representada por qual elemento?', options:['O tri\xE2ngulo','A circunfer\xEAncia','A hexade'], correctIndex:1,
        answer:'A circunfer\xEAncia, a serpente que engole o pr\xF3prio rabo. O tri\xE2ngulo representa a Lei de Tr\xEAs e a figura interna representa a Lei de Oitava.' },
      { f:'Livro', type:'multipla', prompt:'As tr\xEAs leis governam, respectivamente:', options:['Pessoas, empresas e na\xE7\xF5es','Fen\xF4menos, processos e resultados','Passado, presente e futuro'], correctIndex:1,
        answer:'Fen\xF4menos (Lei de Tr\xEAs), processos (Lei de Oitava) e resultados (Lei do Retorno). Tudo que existe cabe numa dessas tr\xEAs gavetas.' },
      { f:'Livro', type:'multipla', prompt:'Segundo o livro, o que acontece se a cobran\xE7a da Lei do Retorno n\xE3o chegar em vida?', options:['Ela se perde','Um descendente seu a recebe','Ela \xE9 anulada'], correctIndex:1,
        answer:'Um descendente estar\xE1 l\xE1 para receber. Tudo que se faz \xE9 contabilizado pela natureza, e o prazo n\xE3o \xE9 escolhido por quem plantou.' },
      { f:'Livro', type:'multipla', prompt:'Qual prov\xE9rbio o livro usa para resumir a Lei do Retorno?', options:['Quem planta vento colhe tempestade','\xC1gua mole em pedra dura','De gr\xE3o em gr\xE3o a galinha enche o papo'], correctIndex:0,
        answer:'Quem planta vento colhe tempestade. A colheita n\xE3o \xE9 s\xF3 proporcional, \xE9 amplificada.' },
      { f:'Aplicado', type:'multipla', prompt:'Uma empresa corta atendimento para economizar e dois anos depois perde participa\xE7\xE3o de mercado. Isso ilustra:', options:['Falha de planejamento apenas','A Lei do Retorno, com atraso entre causa e efeito','Uma coincid\xEAncia de mercado'], correctIndex:1,
        answer:'A Lei do Retorno. O intervalo entre plantio e colheita \xE9 justamente o que faz as pessoas n\xE3o enxergarem a liga\xE7\xE3o, e por isso repetirem o erro.' },
      { f:'Aplicado', type:'multipla', prompt:'Por que a Lei do Retorno \xE9 a mais dif\xEDcil de enxergar na pr\xE1tica?', options:['Porque nem sempre se cumpre','Porque o intervalo entre causa e efeito esconde a liga\xE7\xE3o','Porque s\xF3 vale para grandes decis\xF5es'], correctIndex:1,
        answer:'Pelo intervalo. Quando a colheita chega, a semente j\xE1 saiu do campo de vis\xE3o, e a pessoa atribui o resultado \xE0 sorte ou ao destino.' },
      { f:'Aplicado', type:'livre', prompt:'Aponte um resultado da sua vida hoje que \xE9 colheita direta de algo que voc\xEA plantou h\xE1 mais de um ano. Seja espec\xEDfico sobre a semente.',
        answer:'Crit\xE9rio: a liga\xE7\xE3o entre causa e efeito est\xE1 nomeada com precis\xE3o, sem generalidade. Resposta forte identifica a a\xE7\xE3o concreta e o intervalo de tempo.' },
      { f:'Aplicado', type:'livre', prompt:'O que voc\xEA est\xE1 plantando agora, sem perceber, que vai colher daqui a tr\xEAs anos? Inclua algo que n\xE3o \xE9 confort\xE1vel de admitir.',
        answer:'Crit\xE9rio: identifica pelo menos uma semente atual com honestidade, incluindo uma de efeito indesejado. Resposta que s\xF3 lista boas sementes est\xE1 incompleta.' },
      { f:'Aplicado', type:'livre', prompt:'Descreva uma decis\xE3o sua que trouxe ganho imediato e custo depois. Voc\xEA conseguia ver o custo na hora?',
        answer:'Crit\xE9rio: reconhece o ganho de curto prazo, o custo posterior e \xE9 honesta sobre o quanto era previs\xEDvel. A li\xE7\xE3o est\xE1 no que era vis\xEDvel e foi ignorado, n\xE3o no que era imprevis\xEDvel.' }
    ]
  },
  {
    id:'tres-centros', nome:'Os Tr\xEAs Centros', sub:'A m\xE1quina humana', glifo:'\u2699',
    ...
    resumo:'Mental, Emocional e Corporal. O mental pensa e se alimenta de informa\xE7\xE3o, sede no c\xE9rebro, densidade 12. O emocional sente e se alimenta de oxig\xEAnio, sede nos g\xE2nglios do simp\xE1tico, densidade 24. O corporal se move e se alimenta de comida, exerc\xEDcio, sono e sexo, sede na medula, densidade 48. \xCAxito: vis\xE3o, paix\xE3o e a\xE7\xE3o. Desempenho: intelig\xEAncia, coragem e liberdade.',
    itens:[
      { f:'Livro', type:'multipla', prompt:'Qual \xE9 o alimento do centro emocional?', options:['Informa\xE7\xE3o','Oxig\xEAnio','Comida e bebida'], correctIndex:1,
        answer:'Oxig\xEAnio. Por isso, em abalo emocional, se pede respira\xE7\xE3o profunda. Informa\xE7\xE3o alimenta o mental, comida alimenta o corporal.' },
      { f:'Livro', type:'multipla', prompt:'Onde fica a sede de comando do centro emocional?', options:['No c\xE9rebro','Nos g\xE2nglios nervosos do sistema simp\xE1tico','Na medula espinhal'], correctIndex:1,
        answer:'Nos g\xE2nglios do sistema simp\xE1tico, uma rede neural espalhada pelo corpo inteiro. O c\xE9rebro comanda o mental, a medula comanda o corporal.' },
      { f:'Livro', type:'multipla', prompt:'O \xEAxito do centro mental \xE9 caracterizado por:', options:['Vis\xE3o','Paix\xE3o','A\xE7\xE3o'], correctIndex:0,
        answer:'Vis\xE3o, a capacidade de antever, de enxergar mais longe. Paix\xE3o \xE9 do emocional, a\xE7\xE3o \xE9 do corporal.' },
      { f:'Livro', type:'multipla', prompt:'O desempenho do centro corporal \xE9 caracterizado por:', options:['Intelig\xEAncia','Coragem','Liberdade e versatilidade'], correctIndex:2,
        answer:'Liberdade e versatilidade, coroadas pela capacidade de falar em p\xFAblico com influ\xEAncia.' },
      { f:'Livro', type:'multipla', prompt:'Na persuas\xE3o, quanto pesa a mensagem, o lado puramente intelectual?', options:['7%','38%','55%'], correctIndex:0,
        answer:'7%. O tom de voz pesa 38% e o corpo o restante. Corpo e emo\xE7\xE3o juntos somam 93%. O intelectual sozinho n\xE3o persuade ningu\xE9m.' },
      { f:'Livro', type:'multipla', prompt:'Qual \xE9 a densidade do material que constitui o centro emocional?', options:['12, material solar','24, material planet\xE1rio','48, material terrestre'], correctIndex:1,
        answer:'24, material planet\xE1rio. \xC9 o conciliador. O mental \xE9 12, solar e sutil. O corporal \xE9 48, terrestre e denso.' },
      { f:'Livro', type:'multipla', prompt:'Segundo o livro, qual \xE9 o problema do "mente s\xE3 em corpo s\xE3o"?', options:['Ignora o centro emocional','Valoriza demais o corpo','N\xE3o menciona a alma'], correctIndex:0,
        answer:'Ignora o centro emocional, justamente o respons\xE1vel pelas nossas principais qualidades. O livro trata isso como ferramenta de domina\xE7\xE3o, porque um emocional imaturo \xE9 facilmente dominado.' },
      { f:'Livro', type:'multipla', prompt:'Quais s\xE3o as maiores revela\xE7\xF5es do centro emocional?', options:['Imagina\xE7\xE3o e mem\xF3ria','Confian\xE7a, intui\xE7\xE3o, gratid\xE3o e humildade','For\xE7a, resist\xEAncia e ritmo'], correctIndex:1,
        answer:'Confian\xE7a, intui\xE7\xE3o, gratid\xE3o e humildade. A maior revela\xE7\xE3o do mental \xE9 a imagina\xE7\xE3o.' },
      { f:'Livro', type:'multipla', prompt:'Quando o centro mental n\xE3o chega a uma solu\xE7\xE3o \xFAnica e encontra v\xE1rias alternativas, quem decide?', options:['Ele mesmo, escolhendo a mais prov\xE1vel','O centro emocional','O centro corporal, pela a\xE7\xE3o'], correctIndex:1,
        answer:'O centro emocional. O mental calcula e oferece possibilidades; a escolha \xE9 emocional. Por isso discernimento \xE9 fun\xE7\xE3o do emocional, n\xE3o do intelecto.' },
      { f:'Livro', type:'multipla', prompt:'Segundo o livro, o que sobra para quem tem o emocional imaturo?', options:['Inveja, ci\xFAme, medo e ingratid\xE3o','Pregui\xE7a e desorganiza\xE7\xE3o','Excesso de racionalidade'], correctIndex:0,
        answer:'Inveja, ci\xFAme, medo e ingratid\xE3o. E o livro \xE9 duro: pessoas assim ocupam a maioria dos cargos relevantes na organiza\xE7\xE3o mundial.' },
      { f:'Livro', type:'multipla', prompt:'Segundo o livro, a palavra falada deve ter apenas tr\xEAs objetivos. Quais?', options:['Informar, convencer e vender','Agradecer, curar e prosperar','Ensinar, corrigir e inspirar'], correctIndex:1,
        answer:'Agradecer, curar e prosperar. E o melhor exerc\xEDcio para desenvolver intelig\xEAncia, coragem e liberdade \xE9 a orat\xF3ria espont\xE2nea: simplesmente fazer a pessoa falar.' },
      { f:'Aplicado', type:'multipla', prompt:'Uma pessoa que sabe tudo do assunto mas trava ao apresentar tem qual centro em d\xE9ficit?', options:['Mental','Emocional','Corporal'], correctIndex:1,
        answer:'Emocional. Conhecimento \xE9 mental e j\xE1 est\xE1 l\xE1. O que falta \xE9 coragem, que \xE9 desempenho do emocional. Estudar mais n\xE3o resolve esse tipo de trava.' },
      { f:'Aplicado', type:'multipla', prompt:'Voc\xEA respira fundo antes de uma reuni\xE3o dif\xEDcil. Qual centro est\xE1 sendo alimentado?', options:['Mental','Emocional','Corporal'], correctIndex:1,
        answer:'O emocional, cujo alimento \xE9 o oxig\xEAnio. N\xE3o \xE9 t\xE9cnica de relaxamento gen\xE9rica: \xE9 nutri\xE7\xE3o direta do centro que vai precisar decidir.' },
      { f:'Aplicado', type:'multipla', prompt:'Segundo a propor\xE7\xE3o de persuas\xE3o do livro, um argumento impec\xE1vel dito com voz insegura perde o qu\xEA?', options:['Nada, o argumento se sustenta sozinho','A maior parte, porque 93% est\xE1 em corpo e emo\xE7\xE3o','Apenas parte do impacto visual'], correctIndex:1,
        answer:'A maior parte. O conte\xFAdo responde por 7%. Por isso a mesma tese convence numa boca e morre em outra.' },
      { f:'Aplicado', type:'livre', prompt:'Dos seus tr\xEAs centros, qual est\xE1 mais atrofiado hoje? D\xEA uma evid\xEAncia concreta, n\xE3o uma impress\xE3o.',
        answer:'Crit\xE9rio: aponta um centro e sustenta com um fato observ\xE1vel do comportamento recente, n\xE3o com autoimagem. Sinais de emocional fraco: falta de coragem, indecis\xE3o, inveja, ingratid\xE3o.' },
      { f:'Aplicado', type:'livre', prompt:'Descreva uma decis\xE3o recente em que o mental fez bem o trabalho, gerou alternativas, e o emocional ainda assim escolheu mal. O que aconteceu ali?',
        answer:'Crit\xE9rio: separa com clareza a etapa de gerar alternativas da etapa de escolher, e identifica o que interferiu na escolha. Boa resposta reconhece que decidir \xE9 fun\xE7\xE3o emocional, n\xE3o intelectual.' },
      { f:'Aplicado', type:'livre', prompt:'Como voc\xEA alimentou cada um dos seus tr\xEAs centros nas \xFAltimas 24 horas? Seja literal: informa\xE7\xE3o, oxig\xEAnio, comida e movimento.',
        answer:'Crit\xE9rio: responde nos tr\xEAs, com fatos, e percebe qual ficou desnutrido. O centro que voc\xEA n\xE3o consegue lembrar de ter alimentado \xE9 o que est\xE1 sendo negligenciado.' }
    ]
  },
  {
    id:'estados', nome:'Os Quatro Estados', sub:'N\xEDveis de consci\xEAncia', glifo:'\u25C9',
    ...
    resumo:'Sono, vig\xEDlia comum, consci\xEAncia de si e consci\xEAncia objetiva. A maioria das pessoas vive alternando entre os dois primeiros a vida inteira, e chama de estar acordado o que \xE9 apenas devaneio. Quem n\xE3o conhece as leis n\xE3o enxerga as coisas como elas s\xE3o, mas como aparentam ser. Vive na ilus\xE3o.',
    itens:[
      { f:'Livro', type:'multipla', prompt:'Em qual estado a maioria das pessoas passa a vida acreditando estar acordada?', options:['Sono','Vig\xEDlia comum, o devaneio','Consci\xEAncia de si'], correctIndex:1,
        answer:'Vig\xEDlia comum, tamb\xE9m chamada de consci\xEAncia relativa ou devaneio. \xC9 o estado em que se reage automaticamente, sem se observar.' },
      { f:'Livro', type:'multipla', prompt:'Segundo o livro, quem n\xE3o aplica as tr\xEAs leis vive como?', options:['Sem objetivos','Na ilus\xE3o, vendo as coisas como aparentam ser','Em conflito constante'], correctIndex:1,
        answer:'Na ilus\xE3o. Jung dizia que at\xE9 voc\xEA se tornar consciente, o inconsciente dirige sua vida e voc\xEA chama isso de destino.' },
      { f:'Livro', type:'multipla', prompt:'Quais s\xE3o os quatro estados, em ordem?', options:['Sono, vig\xEDlia comum, consci\xEAncia de si, consci\xEAncia objetiva','Inconsciente, subconsciente, consciente, superconsciente','Rea\xE7\xE3o, reflex\xE3o, decis\xE3o, a\xE7\xE3o'], correctIndex:0,
        answer:'Sono, vig\xEDlia comum (devaneio), consci\xEAncia de si e consci\xEAncia objetiva. Os dois \xFAltimos s\xE3o raros e exigem trabalho deliberado.' },
      { f:'Livro', type:'multipla', prompt:'No conto do Mago e seu Rebanho, por que os carneiros n\xE3o fogem?', options:['Porque est\xE3o presos','Porque foram hipnotizados a se acharem le\xF5es, \xE1guias e magos','Porque n\xE3o sabem o caminho'], correctIndex:1,
        answer:'Porque foram hipnotizados a acreditar numa identidade lisonjeira e a achar que tudo acontece para o bem do rebanho. A cerca n\xE3o \xE9 f\xEDsica, \xE9 de identidade.' },
      { f:'Aplicado', type:'multipla', prompt:'Voc\xEA dirige por um trajeto conhecido e chega sem lembrar do caminho. Em que estado voc\xEA estava?', options:['Consci\xEAncia de si','Vig\xEDlia comum, o devaneio','Consci\xEAncia objetiva'], correctIndex:1,
        answer:'Vig\xEDlia comum. O corpo executou, o mental vagou, e n\xE3o houve observa\xE7\xE3o de si em nenhum momento. \xC9 o estado padr\xE3o da maior parte do dia.' },
      { f:'Aplicado', type:'multipla', prompt:'Qual \xE9 a diferen\xE7a entre lembrar de uma rea\xE7\xE3o sua e ter consci\xEAncia de si?', options:['Nenhuma, s\xE3o a mesma coisa','A consci\xEAncia de si acontece durante o ato, n\xE3o depois','A lembran\xE7a \xE9 mais confi\xE1vel'], correctIndex:1,
        answer:'A consci\xEAncia de si acontece no ato: voc\xEA se observa enquanto age. Lembrar depois \xE9 reconstru\xE7\xE3o, e a reconstru\xE7\xE3o quase sempre favorece quem lembra.' },
      { f:'Aplicado', type:'multipla', prompt:'Algu\xE9m recebe um t\xEDtulo pomposo em vez de aumento e passa a trabalhar mais. Isso \xE9:', options:['Reconhecimento leg\xEDtimo','A hipnose do rebanho: identidade no lugar do interesse','Uma troca justa'], correctIndex:1,
        answer:'A hipnose do rebanho. O t\xEDtulo substitui a percep\xE7\xE3o do pr\xF3prio interesse, exatamente como o mago convencendo o carneiro de que ele \xE9 um le\xE3o.' },
      { f:'Aplicado', type:'livre', prompt:'Descreva um momento recente de consci\xEAncia de si: um instante em que voc\xEA se observou agindo, em vez de simplesmente reagir.',
        answer:'Crit\xE9rio: descreve um instante espec\xEDfico de auto-observa\xE7\xE3o em tempo real, n\xE3o uma reflex\xE3o feita depois. A diferen\xE7a entre lembrar e observar-se no ato \xE9 o n\xFAcleo do exerc\xEDcio.' },
      { f:'Aplicado', type:'livre', prompt:'Qual hipnose voc\xEA aceita hoje sem questionar? Pode ser um t\xEDtulo, um discurso de prop\xF3sito, uma regra de mercado que todo mundo repete.',
        answer:'Crit\xE9rio: nomeia uma cren\xE7a espec\xEDfica que serve mais a outro do que a voc\xEA, e reconhece por que \xE9 confort\xE1vel mant\xEA-la. Resposta gen\xE9rica sobre "a sociedade" n\xE3o conta.' },
      { f:'Aplicado', type:'livre', prompt:'Reconstrua sua \xFAltima hora. Quanto dela foi devaneio e quanto foi presen\xE7a real? Seja honesto sobre a propor\xE7\xE3o.',
        answer:'Crit\xE9rio: propor\xE7\xE3o honesta, com exemplos concretos dos dois estados. Resposta que reivindica presen\xE7a o tempo todo geralmente \xE9 a pr\xF3pria prova do devaneio.' }
    ]
  }
];

/* ===== Base doutrin\xE1ria para a leitura profunda ===== */
const NOTA_INFO = {
  'D\xF3':{ nome:'Percep\xE7\xE3o', trecho:'mental', critico:false, anterior:null,
    funcao:'Funciona como um radar. Recebe os est\xEDmulos dispon\xEDveis no ambiente antes de qualquer processamento. \xC9 a mat\xE9ria-prima de tudo que vem depois.',
    quebra:'Voc\xEA entra nas situa\xE7\xF5es sem ler o ambiente. Perde o que n\xE3o foi dito, o que estava no tom, na hesita\xE7\xE3o, em quem n\xE3o falou. Depois \xE9 surpreendido por coisas que j\xE1 estavam vis\xEDveis para quem prestou aten\xE7\xE3o.',
    consequencia:'Percep\xE7\xE3o fraca contamina a oitava inteira. N\xE3o adianta raciocinar bem sobre uma leitura errada do que estava acontecendo.',
    correcao:'Chegue antes. Fale menos nos primeiros minutos. Antes de opinar, fa\xE7a um invent\xE1rio mental do que est\xE1 na sala e do que est\xE1 faltando ali.' },
  'R\xE9':{ nome:'Absor\xE7\xE3o', trecho:'mental', critico:false, anterior:'D\xF3',
    funcao:'Absorver a informa\xE7\xE3o tal qual ela veio, sem j\xE1 reagir por cima. \xC9 a diferen\xE7a entre receber e interpretar.',
    quebra:'Voc\xEA distorce na entrada. Ouve o que esperava ouvir, traduz para a sua vers\xE3o antes de entender a do outro. O sintoma cl\xE1ssico \xE9 a frase "n\xE3o foi isso que eu disse" aparecendo com frequ\xEAncia nas suas conversas.',
    consequencia:'Tudo que vem depois passa a operar sobre uma informa\xE7\xE3o que j\xE1 n\xE3o \xE9 a original. Voc\xEA raciocina com precis\xE3o sobre um dado errado.',
    correcao:'Repita de volta antes de responder. N\xE3o como t\xE9cnica de escuta ativa decorada, mas como checagem real: se voc\xEA n\xE3o consegue reformular o que o outro disse, voc\xEA n\xE3o absorveu, reagiu.' },
  'Mi':{ nome:'Racioc\xEDnio', trecho:'mental', critico:true, anterior:'R\xE9',
    funcao:'Pensar fundo e gerar o maior n\xFAmero poss\xEDvel de alternativas. O livro \xE9 expl\xEDcito: o centro mental n\xE3o decide, ele oferece possibilidades. Quanto mais alternativas boas, melhor ser\xE1 a decis\xE3o seguinte.',
    quebra:'Poucas alternativas chegam \xE0 mesa. O livro usa a imagem do enxadrista com o rel\xF3gio correndo: a plateia espera, o advers\xE1rio espera, e voc\xEA arrisca um movimento em vez de escolher um. Tamb\xE9m usa a imagem do trevo sem sinaliza\xE7\xE3o, com v\xE1rias sa\xEDdas e nenhuma indica\xE7\xE3o.',
    consequencia:'Esta \xE9 a nota logo antes do primeiro ponto cr\xEDtico da escala. Mi fraco n\xE3o produz s\xF3 uma decis\xE3o ruim em F\xE1: produz tamb\xE9m motiva\xE7\xE3o fraca em Sol, porque ningu\xE9m se entusiasma com uma escolha em que n\xE3o acreditou de verdade.',
    correcao:'Exija de si um n\xFAmero m\xEDnimo de alternativas antes de permitir a decis\xE3o. Tr\xEAs, quatro, cinco. \xC9 aqui que o choque consciente cabe melhor: o esfor\xE7o extra \xE9 de pensamento, n\xE3o de vontade.' },
  'F\xE1':{ nome:'Discernimento', trecho:'emocional', critico:false, anterior:'Mi',
    funcao:'Decidir, com coragem. Aqui a escala deixa de ser mental e passa a ser emocional. Discernimento, no livro, \xE9 a capacidade de fazer escolhas, e \xE9 fun\xE7\xE3o do centro emocional, n\xE3o do intelecto.',
    quebra:'Voc\xEA sabe o que fazer e n\xE3o decide. Ou decide e desdiz na semana seguinte. Ou empurra a decis\xE3o para o grupo, para o prazo, para o momento em que n\xE3o haver\xE1 mais escolha a fazer.',
    consequencia:'Sem decis\xE3o n\xE3o h\xE1 g\xE1s para Sol. O processo passa a andar por in\xE9rcia, e a energia que devia vir da convic\xE7\xE3o passa a vir da cobran\xE7a externa.',
    correcao:'Antes de tratar como falta de coragem, verifique Mi. Se o racioc\xEDnio anterior est\xE1 forte e mesmo assim voc\xEA n\xE3o decide, a\xED sim o problema \xE9 emocional: \xE9 maturidade de centro, e se desenvolve com exposi\xE7\xE3o, n\xE3o com mais informa\xE7\xE3o.' },
  'Sol':{ nome:'Entusiasmo', trecho:'emocional', critico:false, anterior:'F\xE1',
    funcao:'\xC9 onde se concentra todo o g\xE1s necess\xE1rio para a etapa seguinte. Motiva\xE7\xE3o, vontade, paix\xE3o. O que faz vestir a camisa.',
    quebra:'Voc\xEA decide e n\xE3o sustenta. O projeto n\xE3o morre de oposi\xE7\xE3o, morre de inani\xE7\xE3o. Duas semanas depois ningu\xE9m mais fala nele, inclusive voc\xEA.',
    consequencia:'Sem entusiasmo, a manifesta\xE7\xE3o em L\xE1 sai morna, e manifesta\xE7\xE3o morna n\xE3o influencia ningu\xE9m, porque tom de voz e corpo respondem por 93% do poder de persuas\xE3o.',
    correcao:'Entusiasmo baixo quase nunca se resolve olhando para a frente. O livro \xE9 direto: se a escolha anterior n\xE3o foi boa, haver\xE1 pouca motiva\xE7\xE3o para seguir. Olhe para tr\xE1s, para F\xE1 e para Mi.' },
  'L\xE1':{ nome:'Manifesta\xE7\xE3o', trecho:'corporal', critico:false, anterior:'Sol',
    funcao:'\xC9 onde a pessoa mostra o tamanho da sua capacidade, da sua intelig\xEAncia e da sua coragem. O pronunciamento. \xC9 aqui que quem fala define o que vem depois.',
    quebra:'Voc\xEA encolhe a fala para caber no ambiente. Entrega menos do que tem, principalmente diante de quem tem posi\xE7\xE3o. Amacia a opini\xE3o antes de afirm\xE1-la, e o "acho que" aparece na frente do que voc\xEA j\xE1 sabe.',
    consequencia:'Voc\xEA chega at\xE9 aqui com boa an\xE1lise e boa decis\xE3o e desperdi\xE7a as duas na entrega. \xC9 a perda mais evit\xE1vel da oitava inteira.',
    correcao:'O livro aponta um \xFAnico programa como o mais eficaz para desenvolver um profissional: faz\xEA-lo falar. Orat\xF3ria espont\xE2nea, de p\xE9, sem preparo, com tempo curto. N\xE3o \xE9 treino de conte\xFAdo, \xE9 treino de tamanho.' },
  'Si':{ nome:'Influ\xEAncia', trecho:'corporal', critico:true, anterior:'L\xE1',
    funcao:'Influ\xEAncia \xE9 o que acontece no outro depois que voc\xEA falou. N\xE3o \xE9 ser ouvido, n\xE3o \xE9 ser elogiado, n\xE3o \xE9 concord\xE2ncia educada na sala. \xC9 mudan\xE7a de comportamento: a pessoa faz algo que n\xE3o faria se voc\xEA n\xE3o tivesse falado.',
    quebra:'Voc\xEA fala bem e nada muda depois. A reuni\xE3o termina com todo mundo de acordo e nenhuma a\xE7\xE3o nomeada. O elogio vem, o movimento n\xE3o. Manifestar \xE9 L\xE1; fazer acontecer no outro \xE9 Si, e s\xE3o coisas diferentes.',
    consequencia:'Esta \xE9 a nota do segundo ponto cr\xEDtico, entre si e o d\xF3 da oitava seguinte. Quem para aqui n\xE3o fecha o ciclo, e sem fechar o ciclo o pr\xF3ximo recome\xE7a do zero, sem herdar nada do esfor\xE7o anterior.',
    correcao:'O esfor\xE7o extra aqui \xE9 concreto e pequeno: um pedido expl\xEDcito, um respons\xE1vel nomeado, uma data. A maioria dos processos n\xE3o morre por falta de argumento, morre por falta da \xFAltima frase, aquela que transforma concord\xE2ncia em compromisso.' }
};

const CENTRO_DEEP = {
  mental:{ nome:'Centro Mental', funcao:'Pensamento', alimento:'Informa\xE7\xE3o', sede:'C\xE9rebro', densidade:'12, material solar',
    exito:'Vis\xE3o', desempenho:'Intelig\xEAncia', revelacao:'Imagina\xE7\xE3o',
    txt:'Sua for\xE7a natural \xE9 a vis\xE3o: antever, calcular, enxergar mais longe do que o campo imediato. O centro mental se alimenta de informa\xE7\xE3o, tem sede de comando no c\xE9rebro e \xE9 o mais sutil dos tr\xEAs, densidade 12, material solar.',
    limite:'O livro \xE9 categ\xF3rico num ponto que costuma passar despercebido: o centro mental n\xE3o decide. Nas quest\xF5es complexas, onde n\xE3o existe uma solu\xE7\xE3o \xFAnica e sim v\xE1rias alternativas poss\xEDveis, ele passa a bola adiante. Quem decide \xE9 o emocional. Por isso um mental muito desenvolvido, sozinho, produz an\xE1lise excelente e paralisia decis\xF3ria.',
    risco:'Seu risco n\xE3o \xE9 errar de racioc\xEDnio, \xE9 chegar tarde. Analisar at\xE9 que a janela feche, e chamar isso de prud\xEAncia.' },
  emocional:{ nome:'Centro Emocional', funcao:'Sentimento', alimento:'Oxig\xEAnio', sede:'G\xE2nglios do sistema simp\xE1tico', densidade:'24, material planet\xE1rio',
    exito:'Paix\xE3o', desempenho:'Coragem e discernimento', revelacao:'Confian\xE7a, intui\xE7\xE3o, gratid\xE3o e humildade',
    txt:'Sua for\xE7a natural \xE9 a paix\xE3o: envolver-se por inteiro, vestir a camisa. O centro emocional se alimenta de oxig\xEAnio, tem sede numa rede neural espalhada pelo corpo e \xE9 o conciliador da tr\xEDade, densidade 24, material planet\xE1rio. \xC9 dele que vem o discernimento, a capacidade de escolher.',
    limite:'\xC9 o centro mais raro e o mais ignorado. O ditado "mente s\xE3 em corpo s\xE3o" apagou justamente a for\xE7a do meio, e o livro trata isso como ferramenta de domina\xE7\xE3o: um emocional imaturo \xE9 facilmente dominado, porque nele sobram inveja, ci\xFAme, medo e ingratid\xE3o.',
    risco:'Seu risco \xE9 decidir bem sobre base fina. O emocional escolhe entre as alternativas que o mental ofereceu; se o mental n\xE3o trabalhou o suficiente, voc\xEA vai escolher com convic\xE7\xE3o dentro de um leque pobre.' },
  corporal:{ nome:'Centro Corporal', funcao:'Movimento', alimento:'Comida, exerc\xEDcio, sono e sexo', sede:'Medula espinhal', densidade:'48, material terrestre',
    exito:'A\xE7\xE3o', desempenho:'Liberdade e versatilidade', revelacao:'A fala em p\xFAblico com influ\xEAncia',
    txt:'Sua for\xE7a natural \xE9 a a\xE7\xE3o: presen\xE7a, desenvoltura, fazer acontecer. O centro corporal se alimenta de comida, exerc\xEDcio, sono e sexo, tem sede na medula e \xE9 o mais denso dos tr\xEAs, densidade 48, material terrestre. \xC9 dele que sai a maior parte do poder de persuas\xE3o.',
    limite:'A propor\xE7\xE3o do livro \xE9 dura com quem confia s\xF3 no conte\xFAdo: a mensagem responde por 7% da persuas\xE3o, o tom de voz por 38%, e o corpo pelo restante. Corpo e emo\xE7\xE3o juntos s\xE3o 93%. Isso \xE9 uma vantagem enorme para voc\xEA, desde que os outros dois centros estejam alimentados.',
    risco:'Seu risco \xE9 agir antes de ter pensado o suficiente, e compensar com presen\xE7a o que faltou de preparo. Funciona muitas vezes, e \xE9 justamente por funcionar que vira h\xE1bito.' }
};

const TRECHO_INFO = {
  mental:{ nome:'trecho mental', notas:'D\xF3, R\xE9 e Mi',
    desc:'ler a situa\xE7\xE3o, absorver sem distorcer e gerar alternativas antes de escolher',
    verbos:'<strong>Perceber</strong> \xE9 captar o que est\xE1 realmente acontecendo, inclusive o que n\xE3o foi dito. <strong>Absorver</strong> \xE9 deixar a informa\xE7\xE3o entrar como ela veio, sem j\xE1 traduzir para a sua vers\xE3o. <strong>Raciocinar</strong> \xE9 pensar fundo o suficiente para colocar v\xE1rias alternativas boas na mesa, j\xE1 que o centro mental n\xE3o decide, ele oferece possibilidades.' },
  emocional:{ nome:'trecho emocional', notas:'F\xE1 e Sol',
    desc:'escolher entre as alternativas e sustentar a escolha com energia real',
    verbos:'<strong>Discernir</strong> \xE9 decidir, e no livro isso \xE9 fun\xE7\xE3o emocional, n\xE3o intelectual: exige coragem, n\xE3o mais informa\xE7\xE3o. <strong>Entusiasmar</strong> \xE9 o g\xE1s que sobra depois da decis\xE3o, o que faz voc\xEA seguir sem cobran\xE7a externa. Se a decis\xE3o foi fraca, o entusiasmo nasce fraco junto.' },
  corporal:{ nome:'trecho corporal', notas:'L\xE1 e Si',
    desc:'aparecer no seu tamanho real e converter isso em movimento no outro',
    verbos:'<strong>Manifestar</strong> \xE9 se pronunciar mostrando o tamanho da sua capacidade, sem encolher a fala para caber no ambiente. <strong>Influenciar</strong> \xE9 o que acontece depois na outra pessoa: ela faz algo que n\xE3o faria se voc\xEA n\xE3o tivesse falado. Concord\xE2ncia educada na sala n\xE3o \xE9 influ\xEAncia, \xE9 cortesia.' }
};

const CRUZAMENTO = {
  'mental|mental':'Aqui h\xE1 uma contradi\xE7\xE3o que vale encarar. O centro que comanda em voc\xEA \xE9 o mesmo trecho onde sua oitava est\xE1 mais fraca. Isso normalmente significa uma de duas coisas: ou voc\xEA confia tanto na sua leitura que parou de chec\xE1-la, ou est\xE1 usando o mental para outra coisa que n\xE3o pensar sobre o problema em si, como antecipar rea\xE7\xF5es e proteger posi\xE7\xE3o. Vale investigar qual das duas.',
  'mental|emocional':'Este \xE9 o padr\xE3o de manual, e o livro descreve exatamente ele. O mental gera alternativas, mas n\xE3o decide; quem decide \xE9 o emocional. Voc\xEA tem mat\xE9ria-prima de sobra e um conversor fraco. O resultado \xE9 conhecido: an\xE1lise excelente, decis\xE3o adiada, e depois a sensa\xE7\xE3o de que perdeu o timing por circunst\xE2ncia externa. N\xE3o foi circunst\xE2ncia.',
  'mental|corporal':'Voc\xEA pensa bem, decide razoavelmente, e perde na entrega. \xC9 a perda mais cara, porque voc\xEA j\xE1 pagou o custo de todo o trabalho anterior. E \xE9 a mais evit\xE1vel: 93% da persuas\xE3o est\xE1 em corpo e emo\xE7\xE3o, ou seja, o que falta n\xE3o \xE9 conte\xFAdo, \xE9 tamanho na hora de aparecer.',
  'emocional|mental':'Voc\xEA decide com firmeza sobre uma base fina. Coragem n\xE3o falta, informa\xE7\xE3o sim. O risco desse perfil \xE9 acertar v\xE1rias vezes por leitura intuitiva e concluir que o processo mental \xE9 dispens\xE1vel, at\xE9 o dia em que o assunto \xE9 complexo demais para a intui\xE7\xE3o sozinha.',
  'emocional|emocional':'Seu centro mais forte \xE9 onde voc\xEA quebra, o que quase sempre indica que o problema n\xE3o \xE9 capacidade e sim desgaste. Emocional \xE9 o centro que se alimenta de oxig\xEAnio e se esvazia com exposi\xE7\xE3o cont\xEDnua sem recupera\xE7\xE3o. Vale olhar menos para t\xE9cnica de decis\xE3o e mais para o quanto voc\xEA vem sustentando o \xE2nimo de outras pessoas al\xE9m do seu.',
  'emocional|corporal':'Voc\xEA decide com coragem e n\xE3o converte isso em movimento no outro. Decis\xE3o sem manifesta\xE7\xE3o de tamanho vira decis\xE3o interna, que ningu\xE9m acompanha. O livro tem um rem\xE9dio espec\xEDfico e desconfort\xE1vel para isso: falar mais, em p\xFAblico, sem preparo.',
  'corporal|mental':'Voc\xEA faz acontecer e influencia, mas sobre uma leitura que nem sempre foi checada. Esse perfil produz muito, e produz na dire\xE7\xE3o errada com a mesma efici\xEAncia. O ganho aqui n\xE3o vem de agir mais, vem de gastar dez minutos a mais antes de agir.',
  'corporal|emocional':'Voc\xEA tem presen\xE7a e faz acontecer, mas a decis\xE3o que sustenta a a\xE7\xE3o vem fraca ou de fora. O sintoma t\xEDpico \xE9 executar muito bem projetos que voc\xEA n\xE3o escolheu. Vale checar quantas das suas a\xE7\xF5es recentes vieram de uma escolha sua e quantas vieram de uma demanda que voc\xEA absorveu.',
  'corporal|corporal':'Seu centro mais forte \xE9 o mesmo trecho onde a oitava quebra, e no seu caso isso costuma ser espec\xEDfico: voc\xEA tem presen\xE7a de sobra, mas est\xE1 usando a presen\xE7a para conduzir sem pedir. Manifestar voc\xEA manifesta. O que falta \xE9 o passo final, nomear o que precisa acontecer depois.'
};

/* ===== Teste do Eneagrama ===== */
const TESTE_CENTROS = [
  { q:'Diante de um problema novo e complexo, seu primeiro movimento \xE9:',
    o:[{t:'Mapear o cen\xE1rio e levantar todas as alternativas poss\xEDveis',c:'mental'},
       {t:'Sentir o que est\xE1 em jogo e decidir por onde come\xE7ar',c:'emocional'},
       {t:'Come\xE7ar a fazer alguma coisa e ajustar no caminho',c:'corporal'}] },
  { q:'O que mais te cansa num dia dif\xEDcil:',
    o:[{t:'Excesso de informa\xE7\xE3o sem tempo de processar',c:'mental'},
       {t:'Ter que sustentar clima e \xE2nimo dos outros',c:'emocional'},
       {t:'Ter que estar em muitos lugares e resolver na pr\xE1tica',c:'corporal'}] },
  { q:'Quando voc\xEA acerta, geralmente \xE9 porque:',
    o:[{t:'Enxergou antes o que os outros n\xE3o viram',c:'mental'},
       {t:'Teve coragem de bancar uma escolha impopular',c:'emocional'},
       {t:'Se moveu mais r\xE1pido e com mais presen\xE7a',c:'corporal'}] },
  { q:'O elogio que mais te representa:',
    o:[{t:'Voc\xEA pensa longe',c:'mental'},
       {t:'Voc\xEA veste a camisa como ningu\xE9m',c:'emocional'},
       {t:'Com voc\xEA a coisa acontece',c:'corporal'}] },
  { q:'Numa reuni\xE3o tensa, o que voc\xEA faz melhor:',
    o:[{t:'Organizar o racioc\xEDnio e trazer clareza',c:'mental'},
       {t:'Ler o clima e decidir o tom certo',c:'emocional'},
       {t:'Manter presen\xE7a e conduzir a sala',c:'corporal'}] },
  { q:'O que voc\xEA mais evita:',
    o:[{t:'Decidir sem ter analisado o suficiente',c:'mental'},
       {t:'Perder o entusiasmo por algo que era seu',c:'emocional'},
       {t:'Ficar parado esperando as condi\xE7\xF5es ideais',c:'corporal'}] },
  { q:'Sua energia se recupera com:',
    o:[{t:'Sil\xEAncio e informa\xE7\xE3o nova de qualidade',c:'mental'},
       {t:'Conversa verdadeira e ar livre',c:'emocional'},
       {t:'Movimento, comida boa, sono',c:'corporal'}] },
  { q:'Quando erra, normalmente \xE9 porque:',
    o:[{t:'Analisou demais e perdeu o tempo da a\xE7\xE3o',c:'mental'},
       {t:'Deixou a emo\xE7\xE3o do momento decidir',c:'emocional'},
       {t:'Agiu antes de pensar direito',c:'corporal'}] },
  { q:'O que as pessoas mais buscam em voc\xEA:',
    o:[{t:'Uma leitura da situa\xE7\xE3o',c:'mental'},
       {t:'Uma decis\xE3o que ningu\xE9m quer tomar',c:'emocional'},
       {t:'Execu\xE7\xE3o, algu\xE9m que fa\xE7a acontecer',c:'corporal'}] }
];

const TESTE_OITAVA = [
  { nota:'D\xF3', nome:'Percep\xE7\xE3o', desc:'Captar o que realmente est\xE1 acontecendo, sem filtro',
    q:'Eu percebo com clareza o que est\xE1 em jogo antes de qualquer coisa, incluindo o que n\xE3o foi dito.' },
  { nota:'R\xE9', nome:'Absor\xE7\xE3o', desc:'Deixar a informa\xE7\xE3o entrar sem distorcer',
    q:'Eu absorvo o que recebo sem j\xE1 reagir por cima, sem transformar na minha vers\xE3o antes de entender.' },
  { nota:'Mi', nome:'Racioc\xEDnio', desc:'Pensar fundo e gerar alternativas',
    q:'Eu penso a fundo e levanto v\xE1rias alternativas reais antes de escolher, mesmo sob press\xE3o de tempo.' },
  { nota:'F\xE1', nome:'Discernimento', desc:'Decidir, com coragem',
    q:'Eu decido com firmeza no momento certo, mesmo quando a decis\xE3o desagrada algu\xE9m com posi\xE7\xE3o acima.' },
  { nota:'Sol', nome:'Entusiasmo', desc:'A paix\xE3o que d\xE1 g\xE1s ao processo',
    q:'Depois de decidir, eu sustento entusiasmo real, e isso se v\xEA na minha energia, n\xE3o s\xF3 nas palavras.' },
  { nota:'L\xE1', nome:'Manifesta\xE7\xE3o', desc:'Se pronunciar, mostrar o tamanho',
    q:'Eu me manifesto no tamanho da minha capacidade, sem encolher a fala pra caber no ambiente.' },
  { nota:'Si', nome:'Influ\xEAncia', desc:'Fazer a coisa acontecer no outro',
...
function importProgress(file){
  ...
  rd.onload=async()=>{
    try{
      ...
      if(!p||!Array.isArray(p.sessions)) throw new Error('inv\xE1lido');
      state.sessions=p.sessions||[]; state.mastery=p.mastery||{}; state.generated=p.generated||[];
      state.lastDay=p.lastDay||null; state.resting=!!p.resting;
      state.leis=p.leis||{}; state.leisGen=p.leisGen||{}; state.enea=p.enea||null;
      state.eneaHist=p.eneaHist||(p.enea?[p.enea]:[]);
    ...
    }catch(e){ document.getElementById('ioMsg').textContent='N\xE3o consegui ler esse arquivo.'; }
  };
  rd.readAsText(file);
}
...
function carregarJsPDF(){
  ...
  function tentar(i){
    return new Promise(function(resolve, reject){
      if (i >= fontes.length){ reject(new Error('n\xE3o consegui carregar o gerador de PDF')); return; }
...
function montarPdfEnea(e){
  ...
  subtitulo('Teste realizado em '+new Date(e.data).toLocaleDateString('pt-BR')+'  \xB7  Tr\xEAs Poderes');
  y+=6;
  ...
  (function fichaCentroPdf(){
    ...
    const campos=[['Fun\xE7\xE3o',C.funcao],['Alimento',C.alimento],['Sede de comando',C.sede],['Densidade',C.densidade],
      ['\xCAxito',C.exito],['Desempenho',C.desempenho],['Maior revela\xE7\xE3o',C.revelacao]];
    ...
    y+=6;
    par('O que significa cada campo: Fun\xE7\xE3o \xE9 o que esse centro faz por voc\xEA. Alimento \xE9 o que ele processa pra funcionar bem. Sede de comando \xE9 onde ele fica baseado no corpo. Densidade vem da cosmologia do livro, um n\xFAmero que mede o qu\xE3o sutil \xE9 a mat\xE9ria que esse centro usa, quanto menor o n\xFAmero, mais fino; "material solar" significa que ele opera numa mat\xE9ria t\xE3o fina quanto a do pr\xF3prio Sol, nesse sistema. \xCAxito \xE9 o resultado que ele entrega quando funciona bem. Desempenho \xE9 a qualidade que ele desenvolve com o uso. Maior revela\xE7\xE3o \xE9 o insight mais alto que ele pode te dar.', {dim:true});
  })();

  h('Distribui\xE7\xE3o dos tr\xEAs centros');
  ...
  par('Como aparece em voc\xEA: '+txt('anamNotaQuebra'));
  par('Origem prov\xE1vel: '+txt('anamNotaOrigem'));
  par('Corre\xE7\xE3o: '+txt('anamNotaCorrecao'));
  ...
  (function desenharEneagramaPdf(){
    ...
    const ordemPdf=['D\xF3','R\xE9','Mi','F\xE1','Sol','L\xE1','Si'], idxPontoPdf=[9,1,2,4,5,7,8];
    for(let i=1;i<=9;i++){
  ...
  TESTE_OITAVA.forEach(function(n){
    ...
    barra(n.nota+' \xB7 '+n.nome, v, 5, cor);
  });
  y+=4;
  par(txt('anamTrecho'));
  ...
  h('O que \xE9 o choque consciente');
  ...
  doc.text('Gerado pelo app Tr\xEAs Poderes, baseado no livro "Conhe\xE7a e Aprimore Seus Tr\xEAs Poderes".', M, y);
  return doc;
}
...
async function gerarPdfEnea(){
  ...
  try{
    ...
    msg.innerHTML='<strong>N\xE3o consegui montar o PDF.</strong> Tente de novo em instantes.';
...
function updateApiBadge(){
  ...
  else if(API_OK===false){ el.textContent='IA off \xB7 avalia\xE7\xE3o manual'; el.className='api-badge off'; }
...
/* ========== EMBARALHAR ALTERNATIVAS ==========
   Sem isso 69% das respostas ca\xEDam na letra B, e a pessoa se educa a chutar B. */
...
function axisStats(){
  const ax={ raciocinio:{n:0,sum:0,label:'Racioc\xEDnio'}, discernimento:{n:0,sum:0,label:'Discernimento'}, influencia:{n:0,sum:0,label:'Influ\xEAncia'} };
...
const NOTA_EIXO = { 'D\xF3':'raciocinio','R\xE9':'raciocinio','Mi':'raciocinio',
  'F\xE1':'discernimento','Sol':'discernimento','L\xE1':'influencia','Si':'influencia' };
...
function pickNextExercise(){
  ...
  if(ch.variantOf) state.adaptNote='Mesma habilidade, outro contexto. Da primeira vez voc\xEA acertou hesitando ou devagar.';
  else if(ch.generated && ch.modo==='avanco') state.adaptNote='N\xEDvel avan\xE7ado. '+ch.catLabel+' j\xE1 \xE9 seu ponto forte, ent\xE3o aqui a r\xE9gua sobe pra n\xE3o estagnar.';
  else if(ch.generated && ch.modo==='geral') state.adaptNote='Aprimoramento geral em '+ch.catLabel+'. N\xE3o mira um ponto fraco, exercita a habilidade por inteiro.';
  else if(ch.generated) state.adaptNote='Criado sob medida para o seu eixo mais fraco: '+ch.catLabel+'.';
  else if(m&&m.lastNota<=2) state.adaptNote='Errado da \xFAltima vez ('+m.lastNota+'/7). Erro recente volta primeiro.';
  else if(m&&m.attempts) state.adaptNote='Ainda n\xE3o fechou: '+m.lastNota+'/7 na \xFAltima tentativa.';
  else if(weak&&ch.cat===weak&&a[weak].n>0) state.adaptNote='Priorizando '+ch.catLabel+', seu eixo mais baixo (m\xE9dia '+a[weak].avg.toFixed(1)+'/7).';
  ...
  if(state.revisando) state.adaptNote='Modo revis\xE3o. Este exerc\xEDcio voc\xEA j\xE1 resolveu antes, e agora s\xF3 vale como treino.';
}
...
function showSessionDone(){
  ...
  if(state.resting){
    document.getElementById('sdTitle').textContent='Sess\xE3o encerrada';
    document.getElementById('sdText').innerHTML='Hoje voc\xEA fechou <strong>'+pts+'</strong> ponto(s) em <strong>'+today.length+
      '</strong> rodada(s). Total resolvido: <strong>'+solved+'</strong>. Na pr\xF3xima sess\xE3o eu trago quest\xF5es in\xE9ditas, nenhuma repetida.';
    document.getElementById('sdContinue').textContent='Mudei de ideia, continuar';
    document.getElementById('sdRest').style.display='none';
  } else {
    document.getElementById('sdTitle').textContent='Voc\xEA respondeu todas desta vez';
    document.getElementById('sdText').innerHTML='Nada repetido, nada pendente. Foram <strong>'+pts+'</strong> ponto(s) hoje em <strong>'+
      today.length+'</strong> rodada(s). Quer continuar agora com quest\xF5es novas, ou esperar at\xE9 a pr\xF3xima sess\xE3o?';
...
function renderExercise(){
  ...
  document.getElementById('metaRight').textContent=(ex.fonte||'Sob medida')+' \xB7 '+(ex.type==='multipla'?'escolha':'resposta livre')+' \xB7 rodada '+(state.sessions.length+1);
  ...
  if(ex.type==='multipla'){
    ...
    input.placeholder='Escreva sua resposta aqui. Clique em Iniciar antes de come\xE7ar.';
...
function handleChoice(idx){
  ...
  document.getElementById('feedbackText').textContent= ok?'Direto na resposta certa.':'N\xE3o foi essa. O crit\xE9rio est\xE1 abaixo.';
...
async function submitAnswer(){
  ...
  catch(e){ console.error(e); showResult(ex,tB,null,'N\xE3o consegui avaliar automaticamente agora.'); }
}
function showResult(ex,tB,ai,err){
  ...
  document.getElementById('verdictBlock').innerHTML='<span class="verdict '+(ai.correct?'ok':'no')+'">'+
    (ai.correct?'Correto':'N\xE3o bateu com o crit\xE9rio')+' \xB7 '+(ai.conviction==='convicto'?'convicto':'hesitante')+'</span>';
...
async function finalizeSession(ex,tB,aB){
  ...
  // sem avan\xE7o autom\xE1tico: o resultado fica na tela at\xE9 voc\xEA mandar seguir
...
function tiltBeam(nota){
  ...
  const c={7:'Ciclo completo. O infinito se fecha nesse aqui.',6:'Harmonia quase plena, um passo do ciclo.',
    5:'Bom equil\xEDbrio, ainda falta afinar um lado.',4:'Ponto m\xE9dio, eixo ainda se firmando.',
    3:'Igni\xE7\xE3o: a fa\xEDsca est\xE1 a\xED, falta sustentar.',2:'Ainda descompassado, mas o terreno \xE9 firme.',
    1:'Base baixa hoje, sem drama.',0:'Zerado. S\xF3 serve de ch\xE3o pra subir.'};
...
async function buildGenerated(baseEx, opts){
  ...
  const label= baseEx? baseEx.catLabel : (a[eixoAlvo]?a[eixoAlvo].label:'Racioc\xEDnio');
  let prompt;
  if(baseEx){
  ...
  const ex={ id:'gen-'+Date.now()+'-'+Math.random().toString(36).slice(2,7), cat, catLabel:label,
    ...
    fonte: baseEx? 'Variante' : (modo==='avanco'?'Avan\xE7ado':(modo==='geral'?'Amplitude':'Sob medida')),
...
async function generateExercise(baseEx){
  ...
  try{
    ...
    console.error(e);
    if(manual){ load.textContent='N\xE3o consegui gerar agora. Tente de novo em instantes.';
      setTimeout(()=>{ load.textContent='Criando exerc\xEDcio sob medida'; },3000); }
  }finally{
...
async function generateBatch(){
  ...
  const rotulo={reforco:'refor\xE7ando seu ponto fraco', geral:'ampliando o repert\xF3rio', avanco:'subindo a r\xE9gua no ponto forte'};
  atualizar('come\xE7ando');
  ...
  try{
    ...
    if(ok){
      ...
      if(state.currentEx){
        renderExercise();
        if(falhas) console.warn(falhas+' quest\xF5es falharam, '+ok+' entraram');
        return;
      }
    }
    throw ultimoErro || new Error('nenhuma quest\xE3o gerada');
  }catch(e){
    ...
    if(semChave){
      mostrarAviso('<strong>A gera\xE7\xE3o de quest\xF5es precisa da chave da IA.</strong> Nas configura\xE7\xF5es do Worker, adicione a vari\xE1vel <code>ANTHROPIC_API_KEY</code> e publique de novo. Enquanto isso, d\xE1 para revisar o que voc\xEA j\xE1 resolveu.');
    } else {
      mostrarAviso('<strong>N\xE3o consegui preparar as quest\xF5es agora.</strong> Tente de novo, costuma funcionar na segunda. Se insistir, d\xE1 para revisar o que j\xE1 resolveu.<br><span style="opacity:.6; font-size:11px;">Motivo: '+msg.slice(0,80)+'</span>');
    }
  }finally{
...
function renderModList(){
  ...
  document.getElementById('leisBanner').innerHTML= feitos===0
    ? 'Cinco m\xF3dulos, <strong>'+total+'</strong> quest\xF5es, sendo '+doLivro+' do pr\xF3prio autor e o resto aplicado ao dia a dia. O que voc\xEA acerta sai da lista, e o banco cresce quando acaba.'
    : '<strong>'+feitos+'</strong> de '+total+' quest\xF5es dominadas. O que voc\xEA acerta n\xE3o volta, e quando o m\xF3dulo esgota eu gero quest\xF5es novas.';
}
...
function renderModItem(){
  ...
  document.getElementById('modMeta').textContent=(it.type==='multipla'?'escolha':'resposta livre')+' \xB7 '+(p.done+1)+' de '+p.total;
...
function modChoice(idx){
  ...
  document.querySelectorAll('#modChoices .choice-btn').forEach((b,i)=>{
    ...
    if(i===corr) b.classList.add('correct'); else if(i===idx) b.classList.add('wrong'); });
  const ok=idx===corr;
  mostrarModResultado(ok, ok?'Certo.':'N\xE3o foi essa.', it.answer);
  if(ok) marcarModItem();
}
...
function mostrarModResultado(ok, fb, resposta, conv){
  ...
  if(ok===null){ v.innerHTML='<div class="error-note">N\xE3o consegui avaliar automaticamente agora.</div>'; }
  else v.innerHTML='<span class="verdict '+(ok?'ok':'no')+'">'+(ok?'Correto':'N\xE3o bateu com o crit\xE9rio')+(conv?' \xB7 '+conv:'')+'</span>';
...
function mostrarModDone(mod){
  ...
  document.getElementById('doneText').innerHTML= restantes.length
    ? 'Voc\xEA dominou as <strong>'+leisProg(mod).total+'</strong> quest\xF5es de '+mod.nome+'. Ainda faltam <strong>'+restantes.length+'</strong> m\xF3dulo(s). Se quiser continuar aqui, eu gero quest\xF5es in\xE9ditas sobre esta mesma lei.'
    : 'Voc\xEA dominou <strong>todos os m\xF3dulos</strong>. As tr\xEAs leis, os tr\xEAs centros e os quatro estados. Daqui pra frente o treino continua com quest\xF5es geradas sobre as mesmas leis, sempre in\xE9ditas.';
  window.scrollTo({top:0,behavior:'smooth'});
}
...
async function gerarQuestoesModulo(mod, n){
  ...
  try{
    ...
    console.error('Falha ao gerar quest\xF5es do m\xF3dulo', e);
    const msg=String((e && e.message)||'');
    const semChave = API_OK===false || /ANTHROPIC_API_KEY/i.test(msg) || /backend (5\\d\\d|401|403)/i.test(msg);
    const av=document.getElementById('doneAviso');
    av.innerHTML = semChave
      ? '<strong>A gera\xE7\xE3o precisa da chave da IA.</strong> Nas configura\xE7\xF5es do Worker, adicione a vari\xE1vel <code>ANTHROPIC_API_KEY</code> e publique de novo.'
      : '<strong>N\xE3o consegui gerar agora.</strong> Tente de novo, costuma funcionar na segunda.<br><span style="opacity:.6; font-size:11px;">Motivo: '+msg.slice(0,80)+'</span>';
...
const ESCALA=[{t:'Sempre',v:5},{t:'Quase sempre',v:4},{t:'\xC0s vezes',v:3},{t:'Raramente',v:2},{t:'Quase nunca',v:1}];
...
function renderQuiz(){
  ...
  if(quiz.fase===1){
    document.getElementById('eneaPart').textContent='Parte 1 \xB7 Os tr\xEAs centros';
    ...
    document.getElementById('eneaPart').textContent='Parte 2 \xB7 '+it.nota+' \xB7 '+it.nome;
...
function cadeiaOrigem(notas, quebra){
  // Percorre para tr\xE1s at\xE9 achar a primeira nota firme. A origem real \xE9 a nota seguinte a ela.
  const seq=['D\xF3','R\xE9','Mi','F\xE1','Sol','L\xE1','Si'];
...
function mostrarEneaResultado(){
  ...
  document.getElementById('resQuando').textContent='Centro predominante \xB7 teste de '+dt.toLocaleDateString('pt-BR');
  document.getElementById('resCentro').textContent=C.nome;

  document.getElementById('fichaCentro').innerHTML=
    [['Fun\xE7\xE3o',C.funcao],['Alimento',C.alimento],['Sede de comando',C.sede],['Densidade',C.densidade],
     ['\xCAxito',C.exito],['Desempenho',C.desempenho],['Maior revela\xE7\xE3o',C.revelacao]]
  ...
  // distribui\xE7\xE3o dos tr\xEAs centros
  const cc=e.centros||{mental:0,emocional:0,corporal:0};
  ...
  let dTxt;
  if(dif<=2) dTxt='Os tr\xEAs centros aparecem em propor\xE7\xE3o parecida, o que \xE9 raro e favor\xE1vel. Significa que voc\xEA n\xE3o depende de um s\xF3 modo de operar. O cuidado aqui \xE9 outro: sem um centro claramente dominante, a tend\xEAncia \xE9 resolver tudo pelo que a situa\xE7\xE3o pede, e isso pode virar aus\xEAncia de posi\xE7\xE3o pr\xF3pria.';
  else if(cc[ordC[2]]<=1) dTxt='O '+rot[ordC[2]].toLowerCase()+' aparece quase zerado nas suas respostas. Isso n\xE3o significa que ele n\xE3o exista em voc\xEA, significa que voc\xEA n\xE3o recorre a ele quando tem escolha. Segundo o livro, centro que n\xE3o se alimenta atrofia, e o custo aparece justamente nas situa\xE7\xF5es em que os outros dois n\xE3o bastam.';
  else dTxt='O '+rot[ordC[0]].toLowerCase()+' domina com folga, e o '+rot[ordC[2]].toLowerCase()+' aparece bem atr\xE1s. Vale lembrar que a m\xE1quina humana \xE9 uma tr\xEDade e a for\xE7a conciliadora \xE9 a emocional: quando ela n\xE3o est\xE1 no meio, os outros dois operam em vis\xE3o dual, que \xE9 exatamente o que o livro chama de armadilha.';
  document.getElementById('anamCentroDist').textContent=dTxt;

  // nota de quebra
  document.getElementById('resNota').textContent=N.nome+' \xB7 nota '+e.quebra;
  ...
  let origemTxt;
  if(cad.local){
    origemTxt='A nota anterior est\xE1 firme, ent\xE3o a quebra \xE9 local: come\xE7a e termina em '+e.quebra+'. '+N.consequencia;
  } else {
    const O=NOTA_INFO[cad.origem];
    origemTxt='A quebra aparece em '+e.quebra+', mas a cadeia para tr\xE1s mostra que ela n\xE3o come\xE7a ali. '+cad.origem+', '+O.nome.toLowerCase()+
      ', tamb\xE9m est\xE1 baixa, e \xE9 de l\xE1 que vem o problema. '+O.consequencia+' Tratar '+e.quebra+' diretamente vai render pouco enquanto '+cad.origem+' estiver desse jeito.';
  }
  ...
  let critTxt;
  if(N.critico && e.quebra==='Mi') critTxt='Vale notar: Mi \xE9 a \xFAltima nota antes do primeiro ponto cr\xEDtico da escala, onde falta o semitom entre mi e f\xE1. Voc\xEA quebra exatamente onde a pr\xF3pria lei j\xE1 empurra todo mundo para fora do rumo. Isso \xE9 meio consolo e meio alerta: n\xE3o \xE9 fraqueza pessoal, \xE9 o ponto em que ningu\xE9m passa sem esfor\xE7o deliberado. Sem choque consciente ali, o desvio \xE9 o comportamento padr\xE3o, n\xE3o a exce\xE7\xE3o.';
  else if(N.critico) critTxt='Vale notar: Si \xE9 a \xFAltima nota antes do segundo ponto cr\xEDtico, entre si e o d\xF3 da oitava seguinte. \xC9 o ponto em que mais gente desiste, porque a sensa\xE7\xE3o \xE9 de que o trabalho j\xE1 foi feito. Foi quase todo feito. O que falta \xE9 pequeno em esfor\xE7o e decisivo em resultado.';
  else critTxt='Um ponto a seu favor: a nota onde voc\xEA quebra n\xE3o \xE9 nenhum dos dois pontos cr\xEDticos naturais da escala. Isso significa que a quebra \xE9 sua, n\xE3o da lei. N\xE3o depende de choque consciente para ser corrigida, depende de treino direto e repetido, que \xE9 bem mais barato.';
  ...
  document.getElementById('noteBars').innerHTML=TESTE_OITAVA.map(n=>{
    ...
    const crit= info.critico?' <span class="crit-tag">ponto cr\xEDtico</span>':'';
    const c= v<=2?'var(--oxblood-br)':(v>=4?'var(--good)':'var(--brass)');
    const fraca= v<=2?' fraca':'';
    return '<div class="nb-row'+fraca+'">'+
      '<div class="nb-head"><span class="nb-nota"><b>'+n.nota+'</b> \xB7 '+n.nome+crit+'</span>'+
  ...
  document.getElementById('anamTrecho').innerHTML=
    'Olhando as sete notas em blocos, seu ponto mais fr\xE1gil est\xE1 no <strong>'+TF.nome+'</strong> ('+TF.notas+
    '), o de '+TF.desc+', com m\xE9dia '+tr.med[tr.fraco].toFixed(1)+' de 5. O mais firme \xE9 o <strong>'+TS.nome+'</strong> ('+TS.notas+'), m\xE9dia '+
    tr.med[tr.forte].toFixed(1)+'.</p>'+
    '<p>'+TF.verbos+'</p>'+
    '<p>A oitava n\xE3o perdoa desequil\xEDbrio entre trechos. Como o processo \xE9 sequencial, o trecho fraco limita tudo que vem depois dele, por melhor que seja o resto. N\xE3o adianta refor\xE7ar o que j\xE1 est\xE1 forte.';
...
function aplicarGateEnea(){
  ...
  if(pv && e && e.centro && e.quebra){
    ...
    pv.textContent='Seu centro predominante \xE9 o '+C.nome.replace('Centro ','')+', e voc\xEA trava em '+e.quebra+' ('+N.nome+'). O treino di\xE1rio mira esse ponto exato, todos os dias, n\xE3o um gen\xE9rico pra qualquer pessoa.';
  }
  if(lead && lead.email){
...
async function enviarRelatorioPorEmail(nome, email, opts){
  ...
  try{
    ...
    if(!opts.silencioso) console.error('Falha ao enviar relat\xF3rio', err);
...
async function submeterGate(){
  ...
  if(!emailOk){ msg.innerHTML='Digite um email v\xE1lido.'; msg.style.display='block'; emailEl.focus(); return; }
  ...
  if(resultado.ok){
    ...
    document.getElementById('eneaEnviadoTxt').textContent='Relat\xF3rio enviado para '+email+'. Confira tamb\xE9m a caixa de spam.';
    enviado.style.display='block';
  } else {
    const motivo = resultado.erro && resultado.erro.includes('dominio de email nao recebe')
      ? 'Esse email n\xE3o parece existir. Confira se digitou certo.'
      : 'N\xE3o consegui enviar agora. Confira o email digitado e tente de novo.';
...
function renderEneaHist(){
  ...
  document.getElementById('eneaHistList').innerHTML=hist.slice().reverse().map(h=>{
    ...
    return '<button class="'+cls+'" data-data="'+h.data+'">'+
      ...
      '<span class="hist-data">quebra em '+h.quebra+' \xB7 '+NOTA_INFO[h.quebra].nome+'</span></span>'+
  ...
  const partes=[];
  if(ant.centro!==at.centro) partes.push('Seu centro predominante mudou de <strong>'+CENTRO_DEEP[ant.centro].nome+'</strong> para <strong>'+CENTRO_DEEP[at.centro].nome+'</strong>. Mudan\xE7a de centro entre testes costuma refletir fase de vida, n\xE3o estrutura, ent\xE3o vale olhar o que mudou no seu contexto no intervalo.');
  else partes.push('Seu centro predominante se manteve em <strong>'+CENTRO_DEEP[at.centro].nome+'</strong>, o que sugere estrutura e n\xE3o estado passageiro.');
...
function desenharEneagrama(e){
  ...
  // D\xF3 no 9 (topo). Os pontos 3 e 6, v\xE9rtices do tri\xE2ngulo, s\xE3o os dois choques da lei.
  const ordem=['D\xF3','R\xE9','Mi','F\xE1','Sol','L\xE1','Si'];
...
function renderDashboard(){
  ...
  if(!s.length) b.innerHTML='Comece o primeiro exerc\xEDcio do dia para abrir o placar.';
  else if(!today.length) b.innerHTML='Nada hoje ainda. Sua sequ\xEAncia de <strong>'+streak+'</strong> dia(s) depende do exerc\xEDcio de agora.';
  else if(tp>=9&&tp/today.length>=6) b.innerHTML='Dia em <strong>'+tp+'</strong> pontos, no eixo 9. Ritmo e clareza andando juntos.';
  else if(tp>=9) b.innerHTML='<strong>'+tp+'</strong> pontos hoje. Volume alto, mas a m\xE9dia por rodada ainda pede afina\xE7\xE3o.';
  else if(tp>=6) b.innerHTML='<strong>'+tp+'</strong> pontos hoje. Passou do 6, o pr\xF3ximo ciclo \xE9 o 9.';
  else if(tp>=3) b.innerHTML='<strong>'+tp+'</strong> pontos hoje. A fa\xEDsca do 3 acendeu, sustenta at\xE9 o 6.';
  else b.innerHTML='<strong>'+tp+'</strong> ponto(s) hoje. Come\xE7o \xE9 come\xE7o, o 3 est\xE1 logo ali.';
...
function renderAxis(){
  ...
  wrap.innerHTML=Object.keys(a).map(k=>{
    ...
    else if(st.avg>=6) tag='<span class="axis-tag tag-solido">s\xF3lido</span>';
    return '<div class="axis-row"><div class="axis-head">'+
      ...
      '<div style="font-size:10.5px;color:var(--dim);margin-top:3px;">'+(st.n? st.avg.toFixed(1)+'/7 \xB7 '+st.n+'x':'sem dados')+'</div></div>';
  }).join('');
  const n=state.sessions.length;
  const avgT=state.sessions.reduce((x,y)=>x+y.tempoBand,0)/n/3;
  const avgA=state.sessions.reduce((x,y)=>x+y.assertBand,0)/n/4;
  let msg;
  if(n<3) msg='Ainda poucos dados. A partir de <strong>3</strong> rodadas eu come\xE7o a repetir seus erros de prop\xF3sito.';
  else if(avgT-avgA>0.18) msg='Padr\xE3o: voc\xEA responde <strong>r\xE1pido, mas erra ou hesita</strong>. O gargalo \xE9 clareza, n\xE3o velocidade.';
  else if(avgA-avgT>0.18) msg='Padr\xE3o: voc\xEA <strong>acerta com convic\xE7\xE3o, mas demora</strong>. Falta virar reflexo.';
...
function renderRanking(){
  ...
  if(!state.sessions.length){ wrap.innerHTML='<div class="empty-state">Ainda sem sess\xF5es pra ranquear.</div>'; return; }
  if(state.rankTab==='sessao'){
    ...
    const rows=Object.keys(by).map(k=>({d:k,t:by[k].t,c:by[k].c,a:by[k].t/by[k].c})).sort((x,y)=>y.t-x.t).slice(0,10).map((d,i)=>{
      ...
      return '<tr><td><span class="rank-badge '+ax+'">'+r+'</span></td><td>'+d.d+'</td><td>'+d.c+' rodada(s)</td>'+
        '<td class="num-mono">'+d.t+' pts</td><td>m\xE9dia '+d.a.toFixed(1)+'</td></tr>'; }).join('');
    wrap.innerHTML='<table><thead><tr><th>#</th><th>Dia</th><th>Volume</th><th>Soma</th><th>M\xE9dia</th></tr></thead><tbody>'+rows+'</tbody></table>';
  }
}
function renderHistory(){
  ...
  let m;
  if(tR>tP+0.3&&aR<aP-0.3) m='<strong>Aten\xE7\xE3o:</strong> tempo melhorou mas assertividade caiu. Pode ser pressa, n\xE3o clareza.';
  else if(aR>aP+0.3&&Math.abs(tR-tP)<0.3) m='<strong>Bom sinal:</strong> assertividade subindo, tempo est\xE1vel.';
  else if(tR>tP+0.2&&aR>aP+0.2) m='<strong>Progresso real:</strong> os dois eixos melhorando juntos.';
  else if(tR<tP-0.3&&aR<aP-0.3) m='Os dois eixos ca\xEDram. Pode ser cansa\xE7o, vale ajustar o hor\xE1rio do treino.';
  else m='Tend\xEAncia est\xE1vel nas \xFAltimas rodadas.';
...
function renderPerf(){
  ...
  } else { eEl.textContent='\u2014'; eSub.textContent='n\xE3o feito'; }
...
function renderMelhorar(feitosLeis, totalLeis){
  ...
  if(state.sessions.length>=3 && weak && a[weak].n>0){
    itens.push('<strong>'+a[weak].label+'</strong> \xE9 seu eixo mais baixo, m\xE9dia '+a[weak].avg.toFixed(1)+' de 7. O sistema j\xE1 est\xE1 puxando mais quest\xF5es desse tipo pra voc\xEA.');
  }
  if(state.sessions.length>=3){
    const n=state.sessions.length;
    const avgT=state.sessions.reduce((x,y)=>x+y.tempoBand,0)/n/3;
    const avgA=state.sessions.reduce((x,y)=>x+y.assertBand,0)/n/4;
    if(avgT-avgA>0.18) itens.push('Voc\xEA responde r\xE1pido mas erra ou hesita. <strong>Desacelere de prop\xF3sito</strong>: o gargalo \xE9 clareza, n\xE3o velocidade.');
    else if(avgA-avgT>0.18) itens.push('Voc\xEA acerta com convic\xE7\xE3o mas demora. Falta virar reflexo, e isso s\xF3 vem com <strong>repeti\xE7\xE3o di\xE1ria</strong>, n\xE3o com mais estudo.');
  }
  const errados=openPool().filter(e=>{const m=state.mastery[e.id]; return m&&m.attempts;}).length;
  if(errados) itens.push('Tem <strong>'+errados+'</strong> exerc\xEDcio(s) errado(s) na fila de retorno. Eles voltam com prioridade at\xE9 voc\xEA fechar.');
  if(state.enea){
    const nt=TESTE_OITAVA.find(n=>n.nota===state.enea.quebra);
    itens.push('Sua oitava quebra em <strong>'+nt.nota+', '+nt.nome+'</strong>. '+nt.desc+'. \xC9 onde o processo perde for\xE7a antes de fechar o ciclo.');
    const fracos=Object.keys(state.enea.notas).filter(k=>state.enea.notas[k]<=2 && k!==state.enea.quebra);
    if(fracos.length) itens.push('Outras notas baixas na sua oitava: <strong>'+fracos.join(', ')+'</strong>. Duas ou mais notas fracas seguidas costumam ser o mesmo problema, n\xE3o problemas diferentes.');
  } else {
    itens.push('Voc\xEA ainda n\xE3o fez o <strong>teste do eneagrama</strong>. Ele mostra qual dos tr\xEAs centros comanda em voc\xEA e em que nota da oitava seu processo quebra.');
  }
  if(feitosLeis<totalLeis){
    const restantes=MODULOS.filter(m=>leisProg(m).done<leisProg(m).total).map(m=>m.nome);
    itens.push('Faltam <strong>'+(totalLeis-feitosLeis)+'</strong> quest\xF5es nas Leis. Pendentes: '+restantes.join(', ')+'.');
  }
  const days=[...new Set(state.sessions.map(x=>dayKey(x.date)))];
  const hoje=new Date().toLocaleDateString('pt-BR');
  if(state.sessions.length && !days.includes(hoje)) itens.push('Voc\xEA ainda n\xE3o treinou hoje. <strong>Const\xE2ncia vale mais que volume</strong> aqui.');
  if(!itens.length) itens.push('Responda alguns exerc\xEDcios para eu mapear seus pontos fracos.');
...
(async function init(){
  ...
  function abrirRecuperar(){
    document.getElementById('recuperarOverlay').classList.add('show');
    document.getElementById('recuperarMsg').style.display='none';
  }
  document.getElementById('abrirRecuperarLink').addEventListener('click', function(ev){ ev.preventDefault(); abrirRecuperar(); });
  document.querySelectorAll('.abrirRecuperarLink2').forEach(function(a){
    a.addEventListener('click', function(ev){ ev.preventDefault(); abrirRecuperar(); });
  });
  document.getElementById('recuperarClose').addEventListener('click', function(){
    document.getElementById('recuperarOverlay').classList.remove('show');
  });
  document.getElementById('recuperarEnviar').addEventListener('click', async function(){
    const btn=this, msg=document.getElementById('recuperarMsg'), input=document.getElementById('recuperarEmail');
    const email=(input.value||'').trim();
    if(!email){ input.focus(); return; }
    btn.disabled=true; btn.textContent='Enviando...';
    let mensagem='Se esse email tiver uma assinatura ativa, voc\xEA recebe um link de acesso em instantes.';
    try{
    ...
    }catch(e){ mensagem='N\xE3o consegui enviar agora. Tenta de novo em instantes.'; }
  ...
  function mostrarBoasVindas(){
    ...
    document.getElementById('boasVindasNome').textContent = nome ? ('Parab\xE9ns, '+nome+'!') : 'Parab\xE9ns!';
  ...
  (async function(){
    const paramsMagic=new URLSearchParams(location.search);
    const tokenMagico=paramsMagic.get('magic');
    if(tokenMagico){
      try{
        const res=await fetch('/api/magic-verify?token='+encodeURIComponent(tokenMagico));
        const data=await res.json();
        if(data.ok && data.email){
          try{ localStorage.setItem('tres-poderes-lead', JSON.stringify({nome:data.nome||'', email:data.email})); }catch(e){}
        }
      }catch(e){}
      history.replaceState(null,'',location.pathname);
    }
  ...
  document.getElementById('jaAssineiBtn').addEventListener('click', async function(){
    ...
    btn.disabled=false; btn.textContent='J\xE1 assinei, verificar agora';
    msg.style.display='block';
    if(ok){
      ...
      msg.textContent='Ainda n\xE3o encontrei a confirma\xE7\xE3o. Se acabou de pagar, espera um minuto e tenta de novo.';
    }
  });
  ...
  (function initInstallBanner(){
    ...
    if(isIOS){
      txt.innerHTML='<b>Instale o app.</b> Toque em compartilhar, depois "Adicionar \xE0 Tela de In\xEDcio".';
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover">
<title>Tr\xEAs Poderes: por que a pessoa concorda e n\xE3o muda?</title>
<meta name="description" content="Descubra qual dos seus tr\xEAs poderes, racioc\xEDnio, discernimento ou influ\xEAncia, est\xE1 te travando. Teste gratuito baseado no Eneagrama de Gurdjieff, com treino di\xE1rio focado no seu ponto fraco.">
<meta property="og:type" content="website">
<meta property="og:url" content="https://trespoderes.app/lp">
<meta property="og:title" content="Seus Tr\xEAs Poderes: descubra o que est\xE1 te travando">
<meta property="og:description" content="Descubra qual dos seus tr\xEAs poderes, racioc\xEDnio, discernimento ou influ\xEAncia, est\xE1 te travando. Teste gratuito baseado no Eneagrama de Gurdjieff, com treino di\xE1rio focado no seu ponto fraco.">
...
<meta name="twitter:title" content="Seus Tr\xEAs Poderes: descubra o que est\xE1 te travando">
<meta name="twitter:description" content="Descubra qual dos seus tr\xEAs poderes, racioc\xEDnio, discernimento ou influ\xEAncia, est\xE1 te travando. Teste gratuito baseado no Eneagrama de Gurdjieff.">
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .dep-quote::before{ content:'\u201C'; color:var(--brass); }
  .dep-quote::after{ content:'\u201D'; color:var(--brass); }
  .dep-nome{ font-family:'IBM Plex Mono',monospace; font-size:11px; letter-spacing:.04em;
...
<body>
  ...
  <div class="explainer wrap">
    <div class="sec-head">
      <span class="eyebrow">O que \xE9 o eneagrama, de verdade</span>
      <h2 style="font-size:20px;">N\xE3o \xE9 o teste de personalidade que voc\xEA j\xE1 viu por a\xED</h2>
    </div>
    <p>O eneagrama \xE9 um s\xEDmbolo antigo: um c\xEDrculo com um tri\xE2ngulo e uma figura de sete pontas dentro. O tri\xE2ngulo representa a <strong>Lei de Tr\xEAs</strong>, as tr\xEAs for\xE7as que precisam estar presentes para qualquer coisa acontecer de verdade. A figura de sete pontas representa a <strong>Lei da Oitava</strong>, as sete etapas que todo processo atravessa, da primeira percep\xE7\xE3o at\xE9 o resultado final.</p>
    ...
    <div class="legend">
      <div class="legend-item"><span class="legend-dot tri"></span>Tri\xE2ngulo, a Lei de Tr\xEAs</div>
  ...
  <div class="who wrap">
    ...
    <div class="tags-row">
      <span class="tag">Empres\xE1rios</span>
      <span class="tag">M\xE9dicos e profissionais da sa\xFAde</span>
  ...
  <section>
    <div class="wrap" style="max-width:560px;">
      <div class="sec-head">
        ...
        <span class="eyebrow">Uma pr\xE9via</span>
        <h2>\xC9 assim que seu resultado chega</h2>
      </div>
      <div class="preview-card">
        <div class="pv-kicker">Centro predominante</div>
        <div class="pv-title">Centro Mental</div>
        <div class="pv-grid">
          <div><dt>Fun\xE7\xE3o</dt><dd>Pensamento</dd></div>
          <div><dt>Alimento</dt><dd>Informa\xE7\xE3o</dd></div>
          <div><dt>\xCAxito</dt><dd>Vis\xE3o</dd></div>
        </div>
        <p class="pv-blur">Sua for\xE7a natural \xE9 a vis\xE3o. Antever, calcular, enxergar mais longe do que o campo imediato. O livro \xE9 categ\xF3rico num ponto que costuma passar despercebido, o centro mental n\xE3o decide...</p>
        <div class="pv-lock"><span>\u{1F512} O resto chega no seu email, de gra\xE7a</span></div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="wrap" style="max-width:560px;">
      <div class="upsell">
        ...
        <h3 style="margin-top:12px;">O diagn\xF3stico chega no seu email</h3>
        <p>Voc\xEA recebe por email a avalia\xE7\xE3o completa, mostrando onde sua oitava quebra. E pode seguir num treino di\xE1rio que trabalha exatamente esse ponto, entre racioc\xEDnio, discernimento e influ\xEAncia, todos os dias.</p>
        <div class="upsell-tags">
          <span class="tag">Lei de Tr\xEAs</span>
          <span class="tag">Lei da Oitava</span>
          <span class="tag">Lei do Retorno</span>
          <span class="tag">Os Tr\xEAs Centros</span>
...
var MANIFEST_JSON = JSON.stringify({
  name: "Tr\xEAs Poderes",
  short_name: "Tr\xEAs Poderes",
  description: "Racioc\xEDnio, discernimento e influ\xEAncia, baseado no Eneagrama de Gurdjieff.",
  start_url: "/",
  scope: "/",
  display: "standalone",
...
__name2(b64ParaBytes, "b64ParaBytes");
...
__name2(assinaturaKiwifyValida, "assinaturaKiwifyValida");
async function handleKiwify(request, env) {
  ...
  if (env.LEADS) {
    ...
    await env.LEADS.put("debug:ultimo-kiwify-lido", JSON.stringify({ evento, email, quandoChegou: (/* @__PURE__ */ new Date()).toISOString() }));
  }
  ...
  if (env.LEADS) {
    ...
    if (pago) {
      ...
      await env.LEADS.put(chave, JSON.stringify({ status: "ativo", evento, atualizadoEm: (/* @__PURE__ */ new Date()).toISOString() }));
      if (!jaEstavaAtivo && env.BREVO_API_KEY && env.BREVO_FROM_EMAIL) {
        const nome = body.Customer && (body.Customer.full_name || body.Customer.first_name || body.Customer.name) || body.customer && (body.customer.full_name || body.customer.first_name || body.customer.name) || "";
        ...
        try {
          await fetch(BREVO_API_URL, {
            ...
            body: JSON.stringify({
              sender: { email: env.BREVO_FROM_EMAIL, name: env.BREVO_FROM_NAME || "Tr\xEAs Poderes" },
              to: [{ email: emailNorm, name: nome || void 0 }],
              subject: "Assinatura confirmada, seu acesso est\xE1 pronto",
              htmlContent: "<p>" + (nome ? "Oi, " + nome + "." : "Oi.") + '</p><p>Sua assinatura do Tr\xEAs Poderes foi confirmada. Clique no link abaixo para entrar no seu treino agora mesmo.</p><p><a href="' + link + '">' + link + '</a></p><p>O link vale por 24 horas. Se expirar, \xE9 s\xF3 pedir um novo dentro do app, em "J\xE1 sou assinante".</p>'
            })
          });
        } catch (e) {
        }
      ...
      await env.LEADS.put(chave, JSON.stringify({ status: "revogado", evento, atualizadoEm: (/* @__PURE__ */ new Date()).toISOString() }));
    }
  }
  return json({ ok: true, evento, email: emailNorm });
}
__name(handleKiwify, "handleKiwify");
__name2(handleKiwify, "handleKiwify");
async function handleProgress(request, env) {
  ...
  if (env.LEADS) {
    await env.LEADS.put("progresso:" + email, JSON.stringify({ resumo, atualizadoEm: (/* @__PURE__ */ new Date()).toISOString() }));
  }
  return json({ ok: true });
}
__name(handleProgress, "handleProgress");
__name2(handleProgress, "handleProgress");
function gerarTokenMagico() {
  const bytes = new Uint8Array(24);
  crypto.getRandomValues(bytes);
  return Array.from(bytes).map((b) => b.toString(16).padStart(2, "0")).join("");
}
__name(gerarTokenMagico, "gerarTokenMagico");
__name2(gerarTokenMagico, "gerarTokenMagico");
async function handleMagicLink(request, env) {
  if (request.method !== "POST") return json({ error: "use POST" }, 405);
  const mensagemPadrao = "Se esse email tiver uma assinatura ativa, voc\xEA recebe um link de acesso em instantes.";
  let body;
  try {
    body = await request.json();
  } catch (e) {
    return json({ ok: true, mensagem: mensagemPadrao });
  }
  const email = typeof body.email === "string" ? body.email.trim().toLowerCase().slice(0, 200) : "";
  const emailOk = /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email);
  if (!emailOk || !env.LEADS) return json({ ok: true, mensagem: mensagemPadrao });
  try {
    const pagoRaw = await env.LEADS.get("pago:" + email, { type: "json" });
    const pago = !!(pagoRaw && pagoRaw.status === "ativo");
    if (pago) {
      const token = gerarTokenMagico();
      await env.LEADS.put("magic:" + token, JSON.stringify({ email }), { expirationTtl: 86400 });
      if (env.BREVO_API_KEY && env.BREVO_FROM_EMAIL) {
        ...
        await fetch(BREVO_API_URL, {
          ...
          body: JSON.stringify({
            sender: { email: env.BREVO_FROM_EMAIL, name: env.BREVO_FROM_NAME || "Tr\xEAs Poderes" },
            to: [{ email }],
            subject: "Seu link de acesso, Tr\xEAs Poderes",
            htmlContent: '<p>Clique no link abaixo para entrar no seu treino neste aparelho. V\xE1lido por 24 horas.</p><p><a href="' + link + '">' + link + "</a></p>"
          })
        });
      }
    }
...
async function handleMagicVerify(request, env) {
  ...
  if (!token || !env.LEADS) return json({ ok: false });
  try {
    const dados = await env.LEADS.get("magic:" + token, { type: "json" });
    if (!dados || !dados.email) return json({ ok: false });
    await env.LEADS.delete("magic:" + token);
    let nome = "";
    const lead = await env.LEADS.get("lead:" + dados.email, { type: "json" });
    if (lead && lead.nome) nome = lead.nome;
    return json({ ok: true, email: dados.email, nome });
  } catch (e) {
    return json({ ok: false });
  }
}
__name(handleMagicVerify, "handleMagicVerify");
__name2(handleMagicVerify, "handleMagicVerify");
...
function eixoMaisFraco(resumo) {
  const eixos = [
    ["raciocinio", "Racioc\xEDnio", resumo.raciocinio],
    ["discernimento", "Discernimento", resumo.discernimento],
    ["influencia", "Influ\xEAncia", resumo.influencia]
...
__name2(eixoMaisFraco, "eixoMaisFraco");
function pct(v) {
...
async function enviarResumoSemanal(env, email, resumo, nome) {
  ...
  const html = "<p>" + (nome ? "Oi, " + nome + "." : "Oi.") + "</p><p>Aqui est\xE1 o seu status no Tr\xEAs Poderes esta semana:</p><ul><li>Racioc\xEDnio: " + pct(resumo.raciocinio) + "</li><li>Discernimento: " + pct(resumo.discernimento) + "</li><li>Influ\xEAncia: " + pct(resumo.influencia) + "</li></ul><p>Sequ\xEAncia atual: " + (resumo.streak || 0) + " dias. Total de rodadas: " + (resumo.totalSessoes || 0) + ".</p>" + (focoTxt ? "<p><strong>Para come\xE7ar essa semana, foque em " + focoTxt + "</strong>, \xE9 o seu ponto mais fraco agora. O treino j\xE1 vai gerar exerc\xEDcios pra isso assim que voc\xEA abrir o app.</p>" : "<p>Ainda n\xE3o tenho dados suficientes pra apontar um foco. Faz uma rodada esta semana.</p>") + '<p><a href="https://trespoderes.app/">Abrir o treino</a></p>';
  try {
    await fetch(BREVO_API_URL, {
      method: "POST",
      headers: { "api-key": env.BREVO_API_KEY, "content-type": "application/json", accept: "application/json" },
...
__name2(enviarResumoSemanal, "enviarResumoSemanal");
async function rodarResumoSemanal(env) {
  ...
  do {
    ...
    cursor = lista.list_complete ? void 0 : lista.cursor;
  } while (cursor);
}
__name(rodarResumoSemanal, "rodarResumoSemanal");
__name2(rodarResumoSemanal, "rodarResumoSemanal");
...
__name2(handleClaude, "handleClaude");
var index_default = {
  async fetch(request, env) {
    ...
    if (url.pathname === "/api/magic-link") return handleMagicLink(request, env);
    if (url.pathname === "/api/magic-verify") return handleMagicVerify(request, env);
